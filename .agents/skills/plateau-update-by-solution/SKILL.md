...
Read [plateau-create-by-solutions](.agents/skills/plateau-create-by-solutions/SKILL.md) first. The same mapping and normalization rules apply during an update:
...
3. Discover affected structural skills (see [How to identify affected structural skills](.agents/skills/plateau-update-by-solution/SKILL.md#how-to-identify-affected-structural-skills))
...
- [Adding a new solution to a plateau](.agents/skills/plateau-update-by-solution/examples/example-add-solution.md) — based on commit `8d4766e539b2ff9bcc2ec030f767497a20b39307` (`solution-entity-edit-timestamp` added to `plateau-default`)
- [Updating an existing solution in a plateau](.agents/skills/plateau-update-by-solution/examples/example-update-solution.md) — based on commit `3b76d75bf299ce547c23a29821d6612545cbf265` (`solution-command-integration` refactored)
