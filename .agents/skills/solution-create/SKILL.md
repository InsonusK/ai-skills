...
3. When all doubts will be closed start [build solution](.agents/skills/solution-create/SKILL.md#how-to-build-a-solution)

# How to build a solution
1. Use template from [templates](.agents/skills/solution-create/templates/solution-{Solution}.skill.template) folder.
