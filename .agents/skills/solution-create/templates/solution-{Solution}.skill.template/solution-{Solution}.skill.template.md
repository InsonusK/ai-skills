...
2. Add an ADR record using [adr.template.md](.agents/skills/solution-create/templates/solution-{Solution}.skill.template/adr/adr.template.md).
...
See also a complete example: [example.adr.md](.agents/skills/solution-create/templates/solution-{Solution}.skill.template/adr/example.adr.md).
RECOMMENDATION:
- Prefer bullet list
```
```example
...
2. All changes which must be made to implement this solution must be written into the `Implementation/` folder using templates from [Implementation Templates](.agents/skills/solution-create/templates/solution-{Solution}.skill.template/Implementation Templates).
...
Apply the [mermaid-diagram](.agents/skills/mermaid-diagram/SKILL.md) skill:
