...
- `If-Match` header decoded here for update commands — see concurrency-control.solution.skill.md
- `ConflictException<T>` caught here for Guid-carrying commands — see guid-resolving.solution.skill.md

# Governed by

- command-handling.solution.skill.md — full pipeline the controller sits at the top of
- guid-resolving.solution.skill.md — ConflictException handling for creation endpoints
- concurrency-control.solution.skill.md — If-Match decoding for update endpoints

# Structure

## Place in csproj

Defined in `module-api.csproj.skill.md`
...
- module-api.csproj.skill.md — project this controller lives in
- api-minimal-endpoint.class.skill.md — alternative surface for system operations
- command-handling.solution.skill.md — pipeline this controller dispatches into
- guid-resolving.solution.skill.md — ConflictException caught here
- concurrency-control.solution.skill.md — If-Match decoded here