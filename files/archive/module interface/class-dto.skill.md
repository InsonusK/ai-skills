...
# Relations
- csproj-module-interfaces.skill.md — project this DTO lives in
- class-query.skill.md — queries return these DTOs
- class-command.skill.md — command result types are also declared in same file as command
- solution-concurrency-control.skill.md — Version field in DTO enables If-Match on updates
