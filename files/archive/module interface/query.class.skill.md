...
# Governed by
- command-handling.solution.skill.md — IQuery marker excludes query from UnitOfWork pipeline
...
# Relations
- module-interfaces.csproj.skill.md — project this query lives in
- dto.class.skill.md — DTO returned by this query
- feature-query-handler.class.skill.md — single-module handler
- app-queries.csproj.skill.md — cross-module handler location
