...
# Governed by
- solution-domain-events.skill.md — event travels via outbox, handler must be idempotent
- solution-cross-module-communication.skill.md — consuming module subscribes via INotificationHandler
...
# Relations
- csproj-module-interfaces.skill.md — project this event lives in
- solution-domain-events.skill.md — outbox delivers this event to MediatR
- solution-cross-module-communication.skill.md — consuming module subscribes to this event
- class-event-handler.skill.md — idempotent handler in consuming module
