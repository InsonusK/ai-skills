...
Defined in `module-layer.csproj.skill.md`
...
|---|---|---|---|
|/Controllers/{EntityName}|{EntityName}Controller.cs|Collection controller|api-controller.class.skill.md|
|/Controllers/{EntityName}|Single{EntityName}Controller.cs|Single entity controller|api-controller.class.skill.md|
|/Controllers/{EntityName}|Single{EntityName}{Property}Controller.cs|Property controller|api-controller.class.skill.md|
|/Controllers/{EntityName}/{Related}|{EntityName}{Related}Controller.cs|Sub-resource controller|api-controller.class.skill.md|
|/MinimalApi|{Domain}Endpoints.cs|System / cross-entity endpoints|api-minimal-endpoint.class.skill.md|
...
- api-controller.class.skill.md — how to implement a Controller
- api-minimal-endpoint.class.skill.md — how to implement a Minimal API endpoint
- module-layer.csproj.skill.md — Api is one of four module projects
- command-handling.solution.skill.md — full pipeline this layer sits at the top of