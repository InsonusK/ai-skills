...
# Governed by
- solution-guid-resolving.skill.md — full pipeline this contract participates in
...
- class-module-application-resolver.skill.md — implementation of this interface
- solution-guid-resolving.skill.md — full flow
