...
# Governed by
- command-handling.solution.skill.md — handlers use these, never DbContext directly
...
- iunit-of-work.class.skill.md — SaveChanges belongs here, not on repository
- command-handling.solution.skill.md — handlers use these abstractions
- repository.class.skill.md — Application usage patterns
