...
# Relations
- guid-resolving.solution.skill.md — GuidResolvingBehavior in pipeline
- concurrency-control.solution.skill.md — ConcurrencyBehavior in pipeline
- domain-events.solution.skill.md — SaveChanges triggers DomainEventInterceptor
- feature-command-handler.class.skill.md — handler implementation
- api-controller.class.skill.md — controller result mapping
