---
uid:
name: solution-concurrency-control
...
# Depend on
- solution-command-handling.skill.md — ConcurrencyBehavior runs inside command pipeline
...
# Relations
- solution-command-handling.skill.md — pipeline position of ConcurrencyBehavior
- class-entity-concurrency.skill.md — Version field on entity
- class-ef-configuration.skill.md — xmin concurrency token configuration
- class-api-controller.skill.md — If-Match checking and ETag encoding
