...
# Depend on
- solution-entity-behavior.skill.md — behavior methods are where events are raised
...
# Relations
- solution-entity-behavior.skill.md — behavior methods raise events
- solution-command-handling.skill.md — SaveChanges triggered by UnitOfWorkBehavior
- class-entity.skill.md — _domainEvents collection on entity
- class-event-handler.skill.md — idempotent handler implementation
