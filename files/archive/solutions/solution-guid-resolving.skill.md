...
# Depend on
- solution-command-handling.skill.md — GuidResolvingBehavior runs inside command pipeline
...
# Relations
- solution-command-handling.skill.md — pipeline this behavior participates in
- class-entity.skill.md — entity Guid field
- class-ef-configuration.skill.md — unique index configuration
- class-module-application-resolver.skill.md — resolver implementation detail
- class-module-application-di.skill.md — resolver DI registration
