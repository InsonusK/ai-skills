...
# Depend on
- solution-rule-usage.skill.md — entity methods use rules for validation
...
# Relations
- solution-rule-usage.skill.md — rules used inside behavior methods
- solution-domain-events.skill.md — behavior methods raise domain events
- class-entity.skill.md — entity structure
- class-domain-service.skill.md — domain service structure
