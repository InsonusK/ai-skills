...
# Relations
- class-domain-rule.skill.md — rule class structure
- class-value-object.skill.md — VO consumes rules in constructor
- solution-entity-behavior.skill.md — entity methods consume rules
- class-feature-validator.skill.md — validator consumes rules via Must()
