...
- Stryker Mutator is the same vendor/tool family already selected for .NET in [[skills/dotnet/architecture/solutions/solution-dotnet-conformance-testing.skill/solution-dotnet-conformance-testing.skill.md|the dotnet variant]] (as Stryker.NET), keeping the mutation-report shape and mental model consistent across stacks.
