...
- [[skills/dotnet/architecture/artifacts/solutions/🧩validated/solution-validation-behavior.skill/solution-validation-behavior.skill|class-validation-behavior]] - [[skills/dotnet/architecture/artifacts/solutions/🧩validated/solution-validation-behavior.skill/Implementation/BuildingBlocks.csproj.extend/ValidationBehavior.cs.create|ValidationBehavior.cs]]
