...
- This is the per-command validator; for `Soft{ValueObject}` property validators and public RequestDto validators see [[skills/dotnet/architecture/artifacts/plateau/default/structure/{Module}.Application/classes/class-property-validator.skill|class-PropertyValidator]] and [[skills/dotnet/architecture/artifacts/plateau/default/structure/{Module}.Application/classes/class-dto-validator.skill|class-DtoValidator]]

__Applied solutions:__
- [[skills/dotnet/architecture/artifacts/solutions/🧩validated/solution-command-integration.skill/solution-command-integration.skill|solution-command-integration]] - [[skills/dotnet/architecture/artifacts/solutions/🧩validated/solution-command-integration.skill/Implementation/{Module}.Application.csproj.extend/{FeatureName}.Validator.cs.create|{FeatureName}.Validator.cs]]
- [[skills/dotnet/architecture/artifacts/solutions/🧩validated/solution-entity-edit-timestamp.skill/solution-entity-edit-timestamp.skill|solution-entity-edit-timestamp]] - [[skills/dotnet/architecture/artifacts/solutions/🧩validated/solution-entity-edit-timestamp.skill/Implementation/{Module}.Application.csproj.extend/{FeatureName}.Validator.cs.extend|{FeatureName}.Validator.cs]]
