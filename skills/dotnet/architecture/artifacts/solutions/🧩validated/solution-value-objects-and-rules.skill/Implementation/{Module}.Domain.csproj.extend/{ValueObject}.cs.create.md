...
- Multi-property VO has `OwnsOne` EF configuration on owning entity (see [[skills/dotnet/architecture/artifacts/solutions/🧩validated/solution-domain-configuration.skill/solution-domain-configuration.skill|solution-domain-configuration]])
...
# Check list
- [ ] All invariant checks are made by [{Rule}](skills/dotnet/architecture/artifacts/solutions/🧩validated/solution-value-objects-and-rules.skill/Implementation/{Module}.Domain.csproj.extend/{Rule}.cs.create.md)
# Unittest TestCases
