...
| /Entities         | Domain entities that use Value Objects and rules | [[skills/dotnet/architecture/artifacts/solutions/🧩validated/solution-sln-structure.skill/solution-sln-structure.skill\|solution-sln-structure]] | solution-sln-structure.skill]] |
...
- EF Core configuration classes — belong in {Module}.Domain/Configurations per [[skills/dotnet/architecture/artifacts/solutions/🧩validated/solution-domain-configuration.skill/solution-domain-configuration.skill|solution-domain-configuration]]
