...
| --- | --- | --- |
| /Entities | All entity types for this module | [[skills/dotnet/architecture/artifacts/solutions/🧩validated/solution-sln-structure.skill/solution-sln-structure.skill\|solution-sln-structure]] |
| /ValueObjects | All Value Object types for this module | [[skills/dotnet/architecture/artifacts/solutions/🧩validated/solution-value-objects-and-rules.skill/solution-value-objects-and-rules.skill\|solution-value-objects-and-rules]] |
| /Rules | All domain rule static classes for this module | [[skills/dotnet/architecture/artifacts/solutions/🧩validated/solution-value-objects-and-rules.skill/solution-value-objects-and-rules.skill\|solution-value-objects-and-rules]] |
...
| /Configurations | One EF config class per entity | [[skills/dotnet/architecture/artifacts/solutions/🧩validated/solution-domain-configuration.skill/solution-domain-configuration.skill\|solution-domain-configuration]] |
