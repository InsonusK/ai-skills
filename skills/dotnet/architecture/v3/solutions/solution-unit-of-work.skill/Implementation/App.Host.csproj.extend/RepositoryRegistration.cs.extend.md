...
Extend `RepositoryRegistration` from [[skills/dotnet/architecture/v3/solutions/solution-repository-integration.skill/solution-repository-integration.skill|solution-repository-integration.skill]] with `IUnitOfWork` and `UnitOfWorkContext`:
