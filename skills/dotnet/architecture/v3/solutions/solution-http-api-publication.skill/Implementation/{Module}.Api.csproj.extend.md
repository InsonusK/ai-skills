...
## MUST NOT
- Reference `{Module}.Application`, `{Module}.Domain`, `IRepository<T>`, `IUnitOfWork`, `DbContext`, or any domain entity type
- Contain business logic — a conditional beyond mapping input/output is a defect
