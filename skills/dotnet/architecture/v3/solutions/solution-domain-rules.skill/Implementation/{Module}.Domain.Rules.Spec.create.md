...
- A consuming test project links the physical file in via its own `.csproj` (`<None Include="..\{ModuleName}.Domain.Rules.Spec\**\*.feature" Link="..." />`), filtered to the tags that project proves — see [[skills/dotnet/architecture/v3/solutions/solution-domain-rules.skill/Implementation/{Module}.Domain.Rules.Tests.csproj.create|{Module}.Domain.Rules.Tests.csproj]], [[skills/dotnet/architecture/v3/solutions/solution-domain-rules.skill/Implementation/{Module}.Domain.Tests.csproj.extend|{Module}.Domain.Tests.csproj]], [[skills/dotnet/architecture/v3/solutions/solution-domain-rules.skill/Implementation/{Module}.Application.Tests.csproj.extend|{Module}.Application.Tests.csproj]]
...
See [[skills/dotnet/architecture/v3/solutions/solution-domain-rules.skill/Implementation/{Module}.Domain.Rules.Spec.create/{Rule}.feature.create|{Rule}.feature]] for worked `.feature` examples.
