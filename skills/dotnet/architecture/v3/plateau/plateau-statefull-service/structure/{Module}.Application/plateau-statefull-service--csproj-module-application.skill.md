---
name: plateau-statefull-service--csproj-module-application
description: Project {Module}.Application in the statefull-service plateau
...
- /{Module}.Application
  - /Features
    - /{FeatureName}
      - [{FeatureName}.Handler.cs](./classes/plateau-statefull-service--class-feature-handler.skill.md)
      - [{FeatureName}.Validator.cs](./classes/plateau-statefull-service--class-feature-validator.skill.md)
  - /Validators
    - /Property
      - [{ValueObject}PropertyValidator.cs](./classes/plateau-statefull-service--class-property-validator.skill.md)
    - /Model
      - [{Dto}.Validator.cs](./classes/plateau-statefull-service--class-dto-validator.skill.md)
    - /Async
      - [{Feature}Check.cs](./classes/plateau-statefull-service--class-feature-check.skill.md)
  - /Queries
    - /{FeatureName}
      - [{FeatureName}.Handler.cs](./classes/plateau-statefull-service--class-query-handler.skill.md)
  - /Specifications
    - [{Entity}ByIdSpec.cs, {Entity}SummarySpec.cs, {Entity}ByGuidSpec.cs](./classes/plateau-statefull-service--class-specification.skill.md)
  - /Concurrency
    - [{Entity}VersionResolver.cs](./classes/plateau-statefull-service--class-entity-version-resolver.skill.md)
  - /Resolvers
    - [Create{Entity}GuidResolver.cs](./classes/plateau-statefull-service--class-guid-resolver.skill.md)
  - [{Module}ApplicationRegistration.cs](./classes/plateau-statefull-service--class-module-application-registration.skill.md)
  - {Module}.Application.csproj

## Directory and class skills
| `Directory\|file` | Description | Pattern skill |
| --- | --- | --- |
| /Features/{FeatureName} | Handler + transport-correctness validator for one command | [[./classes/plateau-statefull-service--class-feature-handler.skill.md\|class-feature-handler]], [[./classes/plateau-statefull-service--class-feature-validator.skill.md\|class-feature-validator]] |
| /Validators/Property | Reusable `Soft{ValueObject}` validators, resolvable cross-module | [[./classes/plateau-statefull-service--class-property-validator.skill.md\|class-property-validator]] |
| /Validators/Model | Reusable RequestDto validators, resolvable cross-module | [[./classes/plateau-statefull-service--class-dto-validator.skill.md\|class-dto-validator]] |
| /Validators/Async | DI-injected async cross-aggregate checks | [[./classes/plateau-statefull-service--class-feature-check.skill.md\|class-feature-check]] |
| /Queries/{FeatureName} | Single-module read handler (+ optional validator) | [[./classes/plateau-statefull-service--class-query-handler.skill.md\|class-query-handler]] |
| /Specifications | Named query specs — by-id, by-Guid, projection | [[./classes/plateau-statefull-service--class-specification.skill.md\|class-specification]] |
| /Concurrency | Per-entity version resolvers used by `ConcurrencyBehavior` | [[./classes/plateau-statefull-service--class-entity-version-resolver.skill.md\|class-entity-version-resolver]] |
| /Resolvers | Per-entity Guid resolvers used by `GuidResolvingBehavior` | [[./classes/plateau-statefull-service--class-guid-resolver.skill.md\|class-guid-resolver]] |
| {Module}ApplicationRegistration.cs | Module DI self-registration (handlers + validators + resolvers via assembly scan) | [[./classes/plateau-statefull-service--class-module-application-registration.skill.md\|class-module-application-registration]] |
