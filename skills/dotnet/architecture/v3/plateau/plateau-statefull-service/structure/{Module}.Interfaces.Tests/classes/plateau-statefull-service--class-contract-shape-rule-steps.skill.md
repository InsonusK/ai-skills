---
name: plateau-statefull-service--class-contract-shape-rule-steps
description: Class {Rule}Steps in {Module}.Interfaces.Tests, in the statefull-service plateau
