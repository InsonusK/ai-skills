...
registry:
  - "[[skills/dotnet/architecture/v3/plateau/plateau-statefull-service/registry/command-cs.md|command-cs: FMC between external-created-entity and edit-timestamp, unresolved]]"
---
