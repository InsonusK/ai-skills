---
name: plateau-service-with-validated-module-interaction--class-feature-handler
description: Class {FeatureName}Handler in the service-with-validated-module-interaction plateau
