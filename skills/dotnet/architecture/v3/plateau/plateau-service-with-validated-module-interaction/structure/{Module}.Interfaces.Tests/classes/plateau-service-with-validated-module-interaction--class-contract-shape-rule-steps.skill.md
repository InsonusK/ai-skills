---
name: plateau-service-with-validated-module-interaction--class-contract-shape-rule-steps
description: Class {Rule}Steps in {Module}.Interfaces.Tests, in the service-with-validated-module-interaction plateau
