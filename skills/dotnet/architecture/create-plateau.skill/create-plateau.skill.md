...
4. Using all {solutions} create  skills how create plateau elements in created `{output}/structure` using related templates
  - [sln-{name}.skill.md](./templates/sln-Repository.skill.template.md)
  - /{CSProject name}
    - [csproj-{name}.skill.md](./templates/csproj-{name}.skill.template.md)
    - /classes
      - [class-{name}.skill.md](./templates/class-{name}.skill.template.md)
...
6. Add `plateau-{name}.skill.md` using template [plateau-{name}.skill.template.md](./templates/plateau-{plateau-name}.skill.template.md)
