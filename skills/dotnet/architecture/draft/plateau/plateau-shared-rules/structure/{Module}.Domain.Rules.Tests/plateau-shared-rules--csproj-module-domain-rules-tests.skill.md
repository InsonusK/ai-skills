...
- /{Module}.Domain.Rules.Tests
  ...
  - /StepDefinitions
    - [{Rule}RuleSteps.cs](./classes/plateau-shared-rules--class-rule-rule-steps.skill.md)
...
| /StepDefinitions | Bindings that call `{Module}.Domain.Rules`'s real `Check()`/`IsValid()` | [[./classes/plateau-shared-rules--class-rule-rule-steps.skill.md\|class-rule-rule-steps]] |
