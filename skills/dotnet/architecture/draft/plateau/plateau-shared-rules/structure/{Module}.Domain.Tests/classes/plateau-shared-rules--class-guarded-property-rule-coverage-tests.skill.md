---
name: plateau-shared-rules--class-guarded-property-rule-coverage-tests
description: Class GuardedPropertyRuleCoverageTests in the shared-rules plateau — the registry-driven, recursive call-graph Cecil check
