---
name: plateau-shared-rules--csproj-module-domain-tests
description: Project {Module}.Domain.Tests in the shared-rules plateau
...
- Validator-shaped scenarios: input → valid/invalid + error code (see [[./classes/plateau-shared-rules--class-domain-invariant-rule-steps.skill.md|class-domain-invariant-rule-steps]]).
- Once `solution-domain-rules` is applied, `{Module}.Domain.Rules.Spec`'s `@format`-tagged scenarios are linked in here too and proven again through the VO constructor / Entity method — see [[./classes/plateau-shared-rules--class-domain-rule-steps.skill.md|class-domain-rule-steps]].
- `/Architecture` holds the four Mono.Cecil structural checks — build-time guarantees plain unit/BDD tests cannot give by construction, over compiled IL rather than by executing it — see [[./classes/plateau-shared-rules--class-module-architecture-tests.skill.md|class-module-architecture-tests]] and [[./classes/plateau-shared-rules--class-guarded-property-rule-coverage-tests.skill.md|class-guarded-property-rule-coverage-tests]].
...
- /{Module}.Domain.Tests
  - /Rules
    - {Rule}.feature
  - /StepDefinitions
    - [{Rule}Steps.cs](./classes/plateau-shared-rules--class-domain-invariant-rule-steps.skill.md)
    - [{Rule}VoSteps.cs](./classes/plateau-shared-rules--class-domain-rule-steps.skill.md) — `@format` scenarios linked in from `{Module}.Domain.Rules.Spec`
  - /Architecture
    - [{Module}ArchitectureTests.cs](./classes/plateau-shared-rules--class-module-architecture-tests.skill.md)
    - [GuardedPropertyRuleCoverageTests.cs](./classes/plateau-shared-rules--class-guarded-property-rule-coverage-tests.skill.md)
    - {Check}.feature (documentary only, see [[./classes/plateau-shared-rules--class-check-feature.skill.md|class-check-feature]])
...
| /StepDefinitions | Bindings that call `{Module}.Domain`'s real entity/value-object code | [[./classes/plateau-shared-rules--class-domain-invariant-rule-steps.skill.md\|class-domain-invariant-rule-steps]], [[./classes/plateau-shared-rules--class-domain-rule-steps.skill.md\|class-domain-rule-steps]] |
| /Architecture | Mono.Cecil structural checks over compiled `{Module}.Domain`/`{Module}.Domain.Rules` IL | [[./classes/plateau-shared-rules--class-module-architecture-tests.skill.md\|class-module-architecture-tests]], [[./classes/plateau-shared-rules--class-guarded-property-rule-coverage-tests.skill.md\|class-guarded-property-rule-coverage-tests]], [[./classes/plateau-shared-rules--class-check-feature.skill.md\|class-check-feature]] |
