...
- Validator-shaped scenarios: input → valid/invalid + error code (see [[./classes/plateau-shared-rules--class-rule-steps.skill.md|class-rule-steps]]).
...
| /StepDefinitions | Bindings that call `{Module}.Domain`'s real entity/value-object code | [[./classes/plateau-shared-rules--class-rule-steps.skill.md\|class-rule-steps]], [[./classes/plateau-shared-rules--class-domain-rule-steps.skill.md\|class-domain-rule-steps]] |
