...
| /StepDefinitions | Bindings that call `{Module}.Application`'s real handlers/validators | [[./classes/plateau-shared-rules--class-rule-steps.skill.md\|class-rule-steps]], [[./classes/plateau-shared-rules--class-application-rule-steps.skill.md\|class-application-rule-steps]] |
