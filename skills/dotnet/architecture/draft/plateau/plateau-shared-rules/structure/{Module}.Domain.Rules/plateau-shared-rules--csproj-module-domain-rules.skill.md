...
- /{Module}.Domain.Rules
  - /Common
    - [ModuleInfo.cs](./classes/plateau-shared-rules--class-module-info.skill.md)
  - [{Rule}.cs](./classes/plateau-shared-rules--class-rule.skill.md)
...
| --- | --- | --- |
| /Common/ModuleInfo.cs | Module name constant, source of every rejection code's prefix | [[./classes/plateau-shared-rules--class-module-info.skill.md\|class-module-info]] |
| {Rule}.cs | `IsValid()` + `IRuleBuilder` extension + `Check()`, one class per centralized condition | [[./classes/plateau-shared-rules--class-rule.skill.md\|class-rule]] |
