---
name: plateau-shared-rules--module-domain-rules-spec
description: Directory {Module}.Domain.Rules.Spec in the shared-rules plateau — not a project, holds one shared .feature file per rule
...
- /{Module}.Domain.Rules.Spec
  - {Rule}.feature   (see [[../{Module}.Domain.Rules.Tests/classes/plateau-shared-rules--class-rule-rule-steps.skill.md|class-rule-rule-steps]] for the worked `.feature` examples)
