...
# Core Principles
- Shape-shaped scenarios: `{Module}.Interfaces` is declarations-only, so scenarios prove equality/serialization round-trip, never "is this input valid" (see [[./classes/plateau-shared-rules--class-rule-steps.skill.md|class-rule-steps]]).
...
| /StepDefinitions | Bindings that prove equality/serialization | [[./classes/plateau-shared-rules--class-rule-steps.skill.md\|class-rule-steps]] |
