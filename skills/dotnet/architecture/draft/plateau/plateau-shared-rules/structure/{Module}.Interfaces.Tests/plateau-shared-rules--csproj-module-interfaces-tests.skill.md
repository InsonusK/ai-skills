---
name: plateau-shared-rules--csproj-module-interfaces-tests
description: Project {Module}.Interfaces.Tests in the shared-rules plateau
...
# Core Principles
- Shape-shaped scenarios: `{Module}.Interfaces` is declarations-only, so scenarios prove equality/serialization round-trip, never "is this input valid" (see [[./classes/plateau-shared-rules--class-contract-shape-rule-steps.skill.md|class-contract-shape-rule-steps]]).
...
- /{Module}.Interfaces.Tests
  - /Rules
    - {Rule}.feature
  - /StepDefinitions
    - [{Rule}Steps.cs](./classes/plateau-shared-rules--class-contract-shape-rule-steps.skill.md)
...
| /StepDefinitions | Bindings that prove equality/serialization | [[./classes/plateau-shared-rules--class-contract-shape-rule-steps.skill.md\|class-contract-shape-rule-steps]] |
