---
name: plateau-stateless-non-interactive-service--csproj-module-domain-tests
description: Project {Module}.Domain.Tests in the stateless-non-interactive-service plateau
...
- Validator-shaped scenarios: input → valid/invalid + error code (see [[./classes/plateau-stateless-non-interactive-service--class-domain-invariant-rule-steps.skill.md|class-domain-invariant-rule-steps]]).
...
- /{Module}.Domain.Tests
  - /Rules
    - {Rule}.feature
  - /StepDefinitions
    - [{Rule}Steps.cs](./classes/plateau-stateless-non-interactive-service--class-domain-invariant-rule-steps.skill.md)
...
| /StepDefinitions | Bindings that call `{Module}.Domain`'s real entity/value-object code | [[./classes/plateau-stateless-non-interactive-service--class-domain-invariant-rule-steps.skill.md\|class-domain-invariant-rule-steps]] |
