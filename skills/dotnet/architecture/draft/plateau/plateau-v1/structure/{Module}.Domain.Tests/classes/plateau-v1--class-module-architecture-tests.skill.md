---
name: plateau-v1--class-module-architecture-tests
description: Class {Module}ArchitectureTests in the v1 plateau — the three single-pass Cecil checks
...
- Single-pass checks (scan every method once, flag) share this one class — the recursive call-graph check does not belong here, see [[./plateau-v1--class-guarded-property-rule-coverage-tests.skill.md|class-guarded-property-rule-coverage-tests]]
