...
- /Shared
  - /Events
    - IDomainEvent.cs
  - /MediatR
    - [ICommand.cs](./classes/plateau-v1--class-i-command.skill.md)
    - [IQuery.cs](./classes/plateau-v1--class-i-query.skill.md)
  - /Repositories
    - [IRepository.cs, IReadRepository.cs](./classes/plateau-v1--class-i-repository.skill.md)
  - /Results
    - [ConflictResult.cs](./classes/plateau-v1--class-guid-contracts.skill.md)
  - /UnitOfWork
    - [IUnitOfWork.cs](./classes/plateau-v1--class-i-unit-of-work.skill.md)
  - /Outbox
    - IHasDomainEvents.cs
  - /Concurrency
    - [IVersioned.cs, IHasVersions.cs, IEntityVersionResolverFactory.cs, IEntityVersionResolver.cs](./classes/plateau-v1--class-concurrency-contracts.skill.md)
  - /Guid
    - [IHasGuid.cs, IGuidResolver.cs](./classes/plateau-v1--class-guid-contracts.skill.md)
  - /Timestamps
    - [ICreationInfoModel(ReadOnly).cs, IUpdateInfoModel(ReadOnly).cs, ICommandWithTimestamp.cs](./classes/plateau-v1--class-timestamp-contracts.skill.md)
  - /Exceptions
    - [EntityNotLoadedException.cs](./classes/plateau-v1--class-entity-not-loaded-exception.skill.md)
  - Shared.csproj
...
| /MediatR | Command and query marker interfaces | [[./classes/plateau-v1--class-i-command.skill.md\|class-i-command]] |
...
| /Exceptions | `EntityNotLoadedException` — a Handler defect (missing preload), never confused with `DomainException` | [[./classes/plateau-v1--class-entity-not-loaded-exception.skill.md\|class-entity-not-loaded-exception]] |
