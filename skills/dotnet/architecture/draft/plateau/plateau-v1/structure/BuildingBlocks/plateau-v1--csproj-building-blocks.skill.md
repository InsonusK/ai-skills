...
- /BuildingBlocks
  - /MediatR
    - [ExceptionHandlingBehavior.cs](./classes/plateau-v1--class-exception-handling-behavior.skill.md)
    - [ValidationBehavior.cs](./classes/plateau-v1--class-validation-behavior.skill.md)
    - [ConcurrencyBehavior.cs](./classes/plateau-v1--class-concurrency-behavior.skill.md)
    - [UnitOfWorkContext.cs, UnitOfWorkBehavior.cs](./classes/plateau-v1--class-unit-of-work-behavior.skill.md)
    - [GuidResolvingBehavior.cs](./classes/plateau-v1--class-guid-resolving-behavior.skill.md)
  - /Concurrency
    - [ETagEncoder.cs](./classes/plateau-v1--class-concurrency-behavior.skill.md)
...
| ExceptionHandlingBehavior.cs | Catches unhandled exceptions, returns a generic `Result.Error` | [[./classes/plateau-v1--class-exception-handling-behavior.skill.md\|class-exception-handling-behavior]] |
| ValidationBehavior.cs | Collects FluentValidation errors, returns `Result.Invalid` | [[./classes/plateau-v1--class-validation-behavior.skill.md\|class-validation-behavior]] |
| ConcurrencyBehavior.cs | Validates `IHasVersions` expected versions, returns `Result.Conflict` on mismatch | [[./classes/plateau-v1--class-concurrency-behavior.skill.md\|class-concurrency-behavior]] |
| UnitOfWorkContext.cs, UnitOfWorkBehavior.cs | Commits staged changes once per top-level command | [[./classes/plateau-v1--class-unit-of-work-behavior.skill.md\|class-unit-of-work-behavior]] |
| GuidResolvingBehavior.cs | Short-circuits on a duplicate client-generated `Guid` | [[./classes/plateau-v1--class-guid-resolving-behavior.skill.md\|class-guid-resolving-behavior]] |
| /Concurrency/ETagEncoder.cs | Base64 JSON version encoding, unused until an HTTP API layer exists | [[./classes/plateau-v1--class-concurrency-behavior.skill.md\|class-concurrency-behavior]] |
