...
- /{Module}.Application
  - /Features
    - /{FeatureName}
      - [{FeatureName}.Handler.cs](./classes/plateau-v1--class-feature-handler.skill.md)
      - [{FeatureName}.Validator.cs](./classes/plateau-v1--class-feature-validator.skill.md)
  - /Validators
    - /Property
      - [{ValueObject}PropertyValidator.cs](./classes/plateau-v1--class-property-validator.skill.md)
    - /Model
      - [{Dto}.Validator.cs](./classes/plateau-v1--class-dto-validator.skill.md)
    - /Async
      - [{Feature}Check.cs](./classes/plateau-v1--class-feature-check.skill.md)
  - /Queries
    - /{FeatureName}
      - [{FeatureName}.Handler.cs](./classes/plateau-v1--class-query-handler.skill.md)
  - /Specifications
    - [{Entity}ByIdSpec.cs, {Entity}SummarySpec.cs, {Entity}ByGuidSpec.cs](./classes/plateau-v1--class-specification.skill.md)
  - /Concurrency
    - [{Entity}VersionResolver.cs](./classes/plateau-v1--class-entity-version-resolver.skill.md)
  - /Resolvers
    - [Create{Entity}GuidResolver.cs](./classes/plateau-v1--class-guid-resolver.skill.md)
  - [{Module}ApplicationRegistration.cs](./classes/plateau-v1--class-module-application-registration.skill.md)
  - {Module}.Application.csproj

## Directory and class skills
| `Directory\|file` | Description | Pattern skill |
| --- | --- | --- |
| /Features/{FeatureName} | Handler + transport-correctness validator for one command | [[./classes/plateau-v1--class-feature-handler.skill.md\|class-feature-handler]], [[./classes/plateau-v1--class-feature-validator.skill.md\|class-feature-validator]] |
| /Validators/Property | Reusable `Soft{ValueObject}` validators, resolvable cross-module | [[./classes/plateau-v1--class-property-validator.skill.md\|class-property-validator]] |
| /Validators/Model | Reusable RequestDto validators, resolvable cross-module | [[./classes/plateau-v1--class-dto-validator.skill.md\|class-dto-validator]] |
| /Validators/Async | DI-injected async cross-aggregate checks | [[./classes/plateau-v1--class-feature-check.skill.md\|class-feature-check]] |
| /Queries/{FeatureName} | Single-module read handler (+ optional validator) | [[./classes/plateau-v1--class-query-handler.skill.md\|class-query-handler]] |
| /Specifications | Named query specs — by-id, by-Guid, projection | [[./classes/plateau-v1--class-specification.skill.md\|class-specification]] |
| /Concurrency | Per-entity version resolvers used by `ConcurrencyBehavior` | [[./classes/plateau-v1--class-entity-version-resolver.skill.md\|class-entity-version-resolver]] |
| /Resolvers | Per-entity Guid resolvers used by `GuidResolvingBehavior` | [[./classes/plateau-v1--class-guid-resolver.skill.md\|class-guid-resolver]] |
| {Module}ApplicationRegistration.cs | Module DI self-registration (handlers + validators + resolvers via assembly scan) | [[./classes/plateau-v1--class-module-application-registration.skill.md\|class-module-application-registration]] |
