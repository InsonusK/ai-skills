...
- `Sample.Api` exposes the module externally:
  - HTTP: `TasksController` (collection create/list), `SingleTaskController` (get/update), `ResultExtensions` → `ProblemDetails`, per-module Swagger document.
