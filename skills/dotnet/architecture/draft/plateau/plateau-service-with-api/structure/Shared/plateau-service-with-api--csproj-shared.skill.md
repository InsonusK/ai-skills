...
- /Shared
  - /Events
    - IDomainEvent.cs
  - /MediatR
    - [ICommand.cs](./classes/plateau-service-with-api--class-i-command.skill.md)
...
| /MediatR | Command and query marker interfaces | [[./classes/plateau-service-with-api--class-i-command.skill.md\|class-i-command]] |
