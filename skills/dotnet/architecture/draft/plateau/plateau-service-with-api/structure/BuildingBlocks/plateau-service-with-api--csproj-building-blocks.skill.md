---
name: plateau-service-with-api--csproj-building-blocks
description: Project BuildingBlocks in the service-with-api plateau
...
- /BuildingBlocks
  - /MediatR
    - [ExceptionHandlingBehavior.cs](./classes/plateau-service-with-api--class-exception-handling-behavior.skill.md)
    - [ValidationBehavior.cs](./classes/plateau-service-with-api--class-validation-behavior.skill.md)
...
| ExceptionHandlingBehavior.cs | Catches unhandled exceptions, returns a generic `Result.Error` | [[./classes/plateau-service-with-api--class-exception-handling-behavior.skill.md\|class-exception-handling-behavior]] |
| ValidationBehavior.cs | Collects FluentValidation errors, returns `Result.Invalid` | [[./classes/plateau-service-with-api--class-validation-behavior.skill.md\|class-validation-behavior]] |
