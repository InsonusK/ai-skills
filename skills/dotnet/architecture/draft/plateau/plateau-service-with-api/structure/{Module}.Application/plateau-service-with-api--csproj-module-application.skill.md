---
name: plateau-service-with-api--csproj-module-application
description: Project {Module}.Application in the service-with-api plateau
...
- /{Module}.Application
  - /Features
    - /{FeatureName}
      - [{FeatureName}.Handler.cs](./classes/plateau-service-with-api--class-feature-handler.skill.md)
      - [{FeatureName}.Validator.cs](./classes/plateau-service-with-api--class-feature-validator.skill.md)
  - /Validators
    - /Property
      - [{ValueObject}PropertyValidator.cs](./classes/plateau-service-with-api--class-property-validator.skill.md)
    - /Model
      - [{Dto}.Validator.cs](./classes/plateau-service-with-api--class-dto-validator.skill.md)
    - /Async
      - [{Feature}Check.cs](./classes/plateau-service-with-api--class-feature-check.skill.md)
  - /Specifications
  - [{Module}ApplicationRegistration.cs](./classes/plateau-service-with-api--class-module-application-registration.skill.md)
  - {Module}.Application.csproj

## Directory and class skills
| `Directory\|file` | Description | Pattern skill |
| --- | --- | --- |
| /Features/{FeatureName} | Handler + transport-correctness validator for one command | [[./classes/plateau-service-with-api--class-feature-handler.skill.md\|class-feature-handler]], [[./classes/plateau-service-with-api--class-feature-validator.skill.md\|class-feature-validator]] |
| /Validators/Property | Reusable `Soft{ValueObject}` validators, resolvable cross-module | [[./classes/plateau-service-with-api--class-property-validator.skill.md\|class-property-validator]] |
| /Validators/Model | Reusable RequestDto validators, resolvable cross-module | [[./classes/plateau-service-with-api--class-dto-validator.skill.md\|class-dto-validator]] |
| /Validators/Async | DI-injected async cross-aggregate checks | [[./classes/plateau-service-with-api--class-feature-check.skill.md\|class-feature-check]] |
| /Specifications | Query specifications | |
| {Module}ApplicationRegistration.cs | Module DI self-registration (handlers + validators via assembly scan) | [[./classes/plateau-service-with-api--class-module-application-registration.skill.md\|class-module-application-registration]] |
