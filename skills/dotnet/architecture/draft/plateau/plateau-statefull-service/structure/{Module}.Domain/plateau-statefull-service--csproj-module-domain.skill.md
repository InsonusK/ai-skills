...
- /{Module}.Domain
  - /Entities
    - [{Entity}.cs](./classes/plateau-statefull-service--class-entity.skill.md)
  - /ValueObjects
    - [{ValueObject}.cs](./classes/plateau-statefull-service--class-value-object.skill.md)
  - /Services
    - [{Behavior}Service.cs](./classes/plateau-statefull-service--class-behavior-service.skill.md)
  - /Configurations
    - [{Entity}Config.cs](./classes/plateau-statefull-service--class-entity-config.skill.md)
  - {Module}.Domain.csproj

Which of `Version`/`Guid`/timestamp fields an entity has, and whether `solution-entity-concurrency-change`/`solution-external-created-entity` apply to it at all, is decided per-entity by `solution-entity-classification`'s Entity Type Matrix — see `class-entity`.
...
| --- | --- | --- |
| /Entities | All entity types for this module | [[./classes/plateau-statefull-service--class-entity.skill.md\|class-entity]] |
| /ValueObjects | Strict, self-validating Value Object types | [[./classes/plateau-statefull-service--class-value-object.skill.md\|class-value-object]] |
| /Services | Static domain service extensions for bulky entity behavior | [[./classes/plateau-statefull-service--class-behavior-service.skill.md\|class-behavior-service]] |
| /Configurations | One EF Core config class per entity — mapping, concurrency token, unique Guid index, timestamp columns | [[./classes/plateau-statefull-service--class-entity-config.skill.md\|class-entity-config]] |
