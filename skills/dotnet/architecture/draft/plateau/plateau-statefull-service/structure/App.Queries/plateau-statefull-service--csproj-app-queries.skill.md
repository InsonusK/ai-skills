---
name: plateau-statefull-service--csproj-app-queries
description: Project App.Queries in the statefull-service plateau
...
- /App.Queries
  - /Queries
    - /{QueryName}
      - [{QueryName}.Handler.cs](./classes/plateau-statefull-service--class-cross-module-query-handler.skill.md)
  - /Specifications
    - {CrossModule}Spec.cs (optional, `Specification<T, TResult>` projection specs)
  - [AppQueriesRegistration.cs](./classes/plateau-statefull-service--class-app-queries-registration.skill.md)
  - App.Queries.csproj

## Directory and class skills
| `Directory\|file` | Description | Pattern skill |
| --- | --- | --- |
| /Queries/{QueryName} | One cross-module handler (+ optional transport validator) per folder | [[./classes/plateau-statefull-service--class-cross-module-query-handler.skill.md\|class-cross-module-query-handler]] |
| /Specifications | Optional cross-module projection specs | |
| AppQueriesRegistration.cs | DI registration for the App.Queries assembly | [[./classes/plateau-statefull-service--class-app-queries-registration.skill.md\|class-app-queries-registration]] |
