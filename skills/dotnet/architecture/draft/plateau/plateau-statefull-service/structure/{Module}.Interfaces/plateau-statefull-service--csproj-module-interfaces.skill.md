...
- /{Module}.Interfaces
  - /Commands
    - [{Command}.cs](./classes/plateau-statefull-service--class-command.skill.md)
  - /Queries
    - [{Query}.cs](./classes/plateau-statefull-service--class-query.skill.md)
  - /DTOs
    - [{Dto}.cs](./classes/plateau-statefull-service--class-query.skill.md)
  - /Events
  - /ValueObjects
    - [Soft{ValueObject}.cs](./classes/plateau-statefull-service--class-soft-value-object.skill.md)
  - {Module}.Interfaces.csproj

## Directory and class skills
| `Directory\|file` | Description | Pattern skill |
| --- | --- | --- |
| /Commands | Write intent contracts | [[./classes/plateau-statefull-service--class-command.skill.md\|class-command]] |
| /Queries | Read intent contracts | [[./classes/plateau-statefull-service--class-query.skill.md\|class-query]] |
| /DTOs | Response shapes | [[./classes/plateau-statefull-service--class-query.skill.md\|class-query]] |
| /Events | Integration event contracts | |
| /ValueObjects | Permissive, validation-agnostic value-object records | [[./classes/plateau-statefull-service--class-soft-value-object.skill.md\|class-soft-value-object]] |
