---
name: plateau-statefull-service--csproj-app-infrastructure
description: Project App.Infrastructure in the statefull-service plateau
...
- /App.Infrastructure
  - /Persistence
    - [AppDbContext.cs](./classes/plateau-statefull-service--class-appdbcontext.skill.md)
    - /Configurations
      - {Module1}To{Module2}Config.cs — cross-module FK configs (`solution-domain-configuration`)
  - /Repositories
    - [Repository.cs](./classes/plateau-statefull-service--class-repository.skill.md)
  - /UnitOfWork
    - [UnitOfWork.cs](./classes/plateau-statefull-service--class-unit-of-work.skill.md)
  - /Concurrency
    - [EntityVersionResolverFactory.cs](./classes/plateau-statefull-service--class-entity-version-resolver-factory.skill.md)
  - App.Infrastructure.csproj

## Directory and class skills
| `Directory\|file` | Description | Pattern skill |
| --- | --- | --- |
| /Persistence/AppDbContext.cs | The service's single `DbContext` | [[./classes/plateau-statefull-service--class-appdbcontext.skill.md\|class-appdbcontext]] |
| /Persistence/Configurations | Cross-module foreign-key configurations | |
| /Repositories/Repository.cs | Generic EF Core repository | [[./classes/plateau-statefull-service--class-repository.skill.md\|class-repository]] |
| /UnitOfWork/UnitOfWork.cs | `IUnitOfWork` EF Core implementation | [[./classes/plateau-statefull-service--class-unit-of-work.skill.md\|class-unit-of-work]] |
| /Concurrency/EntityVersionResolverFactory.cs | Maps entity names to version resolvers | [[./classes/plateau-statefull-service--class-entity-version-resolver-factory.skill.md\|class-entity-version-resolver-factory]] |
