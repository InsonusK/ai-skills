...
- Validator-shaped scenarios: input → valid/invalid + error code (see [[./classes/plateau-statefull-service--class-domain-invariant-rule-steps.skill.md|class-domain-invariant-rule-steps]]).
...
- /{Module}.Domain.Tests
  - /Rules
    - {Rule}.feature
  - /StepDefinitions
    - [{Rule}Steps.cs](./classes/plateau-statefull-service--class-domain-invariant-rule-steps.skill.md)
...
| /StepDefinitions | Bindings that call `{Module}.Domain`'s real entity/value-object code | [[./classes/plateau-statefull-service--class-domain-invariant-rule-steps.skill.md\|class-domain-invariant-rule-steps]] |
