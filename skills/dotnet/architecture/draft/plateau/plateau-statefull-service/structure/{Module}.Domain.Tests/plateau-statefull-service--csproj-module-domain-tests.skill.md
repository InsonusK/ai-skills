...
- Validator-shaped scenarios: input → valid/invalid + error code (see [[./classes/plateau-statefull-service--class-rule-steps.skill.md|class-rule-steps]]).
...
| /StepDefinitions | Bindings that call `{Module}.Domain`'s real entity/value-object code | [[./classes/plateau-statefull-service--class-rule-steps.skill.md\|class-rule-steps]] |
