---
name: plateau-service-with-validated-module-interaction--class-dto-validator
description: Class {Dto}Validator in the service-with-validated-module-interaction plateau
