---
name: plateau-service-with-validated-module-interaction--class-building-blocks-rule-steps
description: Class {Rule}Steps in BuildingBlocks.Tests, in the service-with-validated-module-interaction plateau
