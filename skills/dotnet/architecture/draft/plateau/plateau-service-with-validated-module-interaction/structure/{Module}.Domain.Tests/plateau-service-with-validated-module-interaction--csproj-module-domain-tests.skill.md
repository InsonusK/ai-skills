---
name: plateau-service-with-validated-module-interaction--csproj-module-domain-tests
description: Project {Module}.Domain.Tests in the service-with-validated-module-interaction plateau
...
- Validator-shaped scenarios: input → valid/invalid + error code (see [[./classes/plateau-service-with-validated-module-interaction--class-domain-invariant-rule-steps.skill.md|class-domain-invariant-rule-steps]]).
...
- /{Module}.Domain.Tests
  - /Rules
    - {Rule}.feature
  - /StepDefinitions
    - [{Rule}Steps.cs](./classes/plateau-service-with-validated-module-interaction--class-domain-invariant-rule-steps.skill.md)
...
| /StepDefinitions | Bindings that call `{Module}.Domain`'s real entity/value-object code | [[./classes/plateau-service-with-validated-module-interaction--class-domain-invariant-rule-steps.skill.md\|class-domain-invariant-rule-steps]] |
