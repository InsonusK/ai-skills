...
| /StepDefinitions | Bindings that call `{Module}.Domain`'s real entity/value-object code | [[./classes/plateau-service-with-validated-module-interaction--class-rule-steps.skill.md\|class-rule-steps]] |
