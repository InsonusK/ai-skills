---
name: plateau-service-with-validated-module-interaction--csproj-app-host
description: Project App.Host in the service-with-validated-module-interaction plateau
...
- /App.Host
  - /DependencyInjection
    - [ModuleRegistration.cs](./classes/plateau-service-with-validated-module-interaction--class-module-registration.skill.md)
    - [PipelineRegistration.cs](./classes/plateau-service-with-validated-module-interaction--class-pipeline-registration.skill.md)
  - Program.cs
  - App.Host.csproj
...
| ModuleRegistration.cs | Centralized module registration extension (`AddModules()`) | [[./classes/plateau-service-with-validated-module-interaction--class-module-registration.skill.md\|class-module-registration]] |
| PipelineRegistration.cs | Centralized pipeline behavior registration (`AddPipeline()`), `ExceptionHandlingBehavior` first | [[./classes/plateau-service-with-validated-module-interaction--class-pipeline-registration.skill.md\|class-pipeline-registration]] |
