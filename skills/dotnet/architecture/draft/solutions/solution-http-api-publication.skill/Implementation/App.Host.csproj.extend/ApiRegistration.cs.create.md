...
## MUST NOT
- Register a single solution-wide `v1` Swagger document covering every module's routes
- Let one module's routes appear in another module's `DocInclusionPredicate` arm
