...
## MUST NOT
- Reimplement the condition inline instead of exercising the real VO/Entity
- Bind an `@semantic`/`@domain`-tagged scenario — those have no VO/Entity adapter to prove
