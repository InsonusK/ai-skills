...
- BuildingBlocks
- App.Infrastructure and App.Queries are not created by this solution — a persistence-introducing solution (e.g. `solution-repository-integration`) adds them here once applied
