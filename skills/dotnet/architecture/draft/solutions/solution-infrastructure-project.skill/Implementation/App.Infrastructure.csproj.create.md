...
## MUST NOT
- Be referenced by any module `Application`, `Domain`, or `Api` project directly — only through abstractions in `Shared`
- Contain any integration-specific code (persistence, cache, ...) as part of this solution
