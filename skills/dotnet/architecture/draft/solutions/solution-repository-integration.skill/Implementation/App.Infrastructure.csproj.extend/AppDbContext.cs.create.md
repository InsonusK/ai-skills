...
## MUST NOT
- Register a `DbSet<T>` property or an `IEntityTypeConfiguration<T>` by hand instead of via the assembly scan
- Be referenced by any module `Application` or `Domain` project directly
