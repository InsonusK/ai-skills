...
- Never inject repositories, `DbContext`, or services
- Never contain business rules
- Never duplicate rules already defined in `{ValueObject}PropertyValidator` or `{Dto}Validator`

## SHOULD
- Avoid query validator with business rules
- Avoid duplicating Soft{ValueObject} validation instead of using `IValidator<Soft{ValueObject}>`
