...
depends_on:
adr:
  - "[[skills/dotnet/architecture/solutions/solution-central-package-management.skill/adr/cpm-over-inline-versions|Central Package Management over inline PackageReference versions]]"
---
...
# Requirements
SOLUTION:
- None — this is a foundation solution, applied before or alongside [[skills/dotnet/architecture/solutions/solution-sln-structure.skill/solution-sln-structure.skill|solution-sln-structure]].
...
PROJECT:
- [[skills/dotnet/architecture/solutions/solution-central-package-management.skill/Implementation/Directory.Packages.props.create|Directory.Packages.props]] - create - the single home for every NuGet package version in the repository
...
## MUST
- [[skills/dotnet/architecture/solutions/solution-central-package-management.skill/Implementation/Directory.Packages.props.create#MUST|Directory.Packages.props]]
