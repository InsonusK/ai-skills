...
adr:
  - "[[skills/dotnet/architecture/solutions/solution-grpc-client.skill/adr/generated-stub-behind-shared-result-interface|Generated stub behind a narrow Shared Result-returning interface]]"
---
...
SOLUTION:
- [[skills/dotnet/architecture/solutions/solution-infrastructure-project.skill/solution-infrastructure-project.skill|solution-infrastructure-project]]
  - [[skills/dotnet/architecture/solutions/solution-infrastructure-project.skill/Implementation/App.Infrastructure.csproj.create|App.Infrastructure.csproj]] - hosts `Protos/` and `Clients/`
- [[skills/dotnet/architecture/solutions/solution-app-logging.skill/solution-app-logging.skill|solution-app-logging]]
  - `ILogger<{Dependency}GrpcClient>` - the adapter logs a mapped failure once, at `Warning`

NUGET (versions in `Directory.Packages.props` per [[skills/dotnet/architecture/solutions/solution-central-package-management.skill/solution-central-package-management.skill|solution-central-package-management]]):
...
PROJECT:
- [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/Implementation/Shared.csproj.extend|Shared.csproj]] - extend - add `Clients/` for the per-dependency contracts
  - [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/Implementation/Shared.csproj.extend/I{Dependency}Client.cs.create|I{Dependency}Client.cs]] - create - narrow per-dependency contract returning `Result<T>`
- [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/Implementation/App.Infrastructure.csproj.extend|App.Infrastructure.csproj]] - extend - add `Protos/` + `Clients/`, `Grpc.Tools` client codegen
  - [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/Implementation/App.Infrastructure.csproj.extend/{Dependency}.proto.create|{Dependency}.proto]] - create - vendored copy of the dependency's contract, `GrpcServices=Client`
  - [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/Implementation/App.Infrastructure.csproj.extend/{Dependency}GrpcClient.cs.create|{Dependency}GrpcClient.cs]] - create - adapter: generated stub → `Result<T>`
  - [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/Implementation/App.Infrastructure.csproj.extend/GrpcStatusExtensions.cs.create|GrpcStatusExtensions.cs]] - create - `RpcException`/`StatusCode` → `Result` mapping (mirror of `solution-grpc-integration`'s `ToRpcException`)
- [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/Implementation/App.Host.csproj.extend|App.Host.csproj]] - extend - `AddGrpcClients()` — one `AddGrpcClient<T>()` per dependency, channel + resilience
  - [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/Implementation/App.Host.csproj.extend/GrpcClientRegistration.cs.create|GrpcClientRegistration.cs]] - create - the registration extension
...
## MUST
- [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/Implementation/Shared.csproj.extend/I{Dependency}Client.cs.create#MUST|I{Dependency}Client.cs]]
- [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/Implementation/App.Infrastructure.csproj.extend/{Dependency}GrpcClient.cs.create#MUST|{Dependency}GrpcClient.cs]]
- [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/Implementation/App.Host.csproj.extend/GrpcClientRegistration.cs.create#MUST|GrpcClientRegistration.cs]]
