...
7. This solution does not decide which `make` targets run on which trigger, or how `public/` gets published — that's owned by the project's own CI configuration.
