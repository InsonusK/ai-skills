...
# Goals
- Add the gRPC transport to the shared `ApiRegistration` partial (from [[skills/dotnet/architecture/solutions/solution-api-project.skill/solution-api-project.skill|solution-api-project]]) — implement `AddGrpcApiTransport`/`UseGrpcApiTransport`.
