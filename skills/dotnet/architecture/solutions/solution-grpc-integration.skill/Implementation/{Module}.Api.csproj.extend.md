...
- Never reference `{Module}.Application`, `{Module}.Domain`, `IRepository<T>`, `IUnitOfWork`, `DbContext`, or any domain entity type — same boundary `solution-http-api-publication` holds for Controllers
