...
| --- | --- | --- |
| /Entities | All entity types for this module | [[skills/dotnet/architecture/solutions/solution-structure.solution.skill/solution-structure.solution.skill.md\|solution-structure.solution.skill]] |
| /ValueObjects | All Value Object types for this module | [[skills/dotnet/architecture/solutions/value-objects-and-rules.solution.skill/value-objects-and-rules.solution.skill.md\|value-objects-and-rules.solution.skill]] |
| /Rules | All domain rule static classes for this module | [[skills/dotnet/architecture/solutions/value-objects-and-rules.solution.skill/value-objects-and-rules.solution.skill.md\|value-objects-and-rules.solution.skill]] |
...
| /Configurations | One EF config class per entity | [[skills/dotnet/architecture/solutions/domain-configuration.solution.skill/domain-configuration.solution.skill.md\|domain-configuration.solution.skill]] |
