...
# Check list
- [ ] All properties except GUID and Id (primary key and foreing key) which has invariant checks use [{ValueObject}](skills/dotnet/architecture/solutions/🧩validated/solution-value-objects-and-rules.skill/Implementation/{Module}.Domain.csproj.extend/{ValueObject}.cs.create.md) which implements invariant checks
# Unittest TestCases
