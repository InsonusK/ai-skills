...
- [[skills/dotnet/architecture/solutions/solution-entity-classification.skill/Implementation/{Module}.Domain.csproj.extend/{Entity}.cs.extend|{Entity}.cs]]
- [[skills/dotnet/architecture/solutions/solution-entity-classification.skill/Implementation/{Module}.Domain.csproj.extend/{Entity}Config.cs.extend|{Entity}Config.cs]]
