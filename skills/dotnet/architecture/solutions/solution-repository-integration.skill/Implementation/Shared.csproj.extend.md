...
- Never reference `Ardalis.Specification.EntityFrameworkCore` in Shared
- Never add custom method signatures to the interfaces unless they are cross-cutting concerns

## SHOULD
- Avoid duplicating Ardalis method signatures manually instead of inheriting the base interfaces
- Avoid adding infrastructure concerns to the repository interfaces
