...
Extend `RepositoryRegistration` from [[skills/dotnet/architecture/solutions/solution-repository-integration.skill/solution-repository-integration.skill|solution-repository-integration]] with `IUnitOfWork` and `UnitOfWorkContext`:
