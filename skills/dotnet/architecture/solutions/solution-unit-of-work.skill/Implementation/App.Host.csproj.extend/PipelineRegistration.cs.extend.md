...
- Never register `UnitOfWorkBehavior` before `ValidationBehavior`, `ConcurrencyBehavior`, or `GuidResolvingBehavior` — a rejected request must never reach the commit stage
