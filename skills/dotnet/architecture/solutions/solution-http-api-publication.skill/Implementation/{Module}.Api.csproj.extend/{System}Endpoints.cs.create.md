...
- Never publish an operation here that addresses one identified entity — that belongs in a Controller
- Never perform business logic inside the endpoint delegate
