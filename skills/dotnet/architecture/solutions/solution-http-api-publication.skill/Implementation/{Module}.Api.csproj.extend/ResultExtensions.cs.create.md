...
- Never include a status this module's handlers never return — dead arms drift from reality the same way an unmapped one does
- Never return the raw exception message or stack trace in any `ProblemDetails.Detail`
