...
- Never expose public setters on class-level timestamp properties.

## SHOULD
- Avoid adding all four timestamp fields to every entity.
- Avoid implementing mutable interfaces implicitly with public setters.
- Avoid forgetting explicit interface implementation and breaking compilation when setters are `internal`.
