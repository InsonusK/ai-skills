...
tags:
  ...
  - element/icommandwithtimestamp-cs
---
...
- Never add methods or other properties.
- Never be implemented by delete commands or query objects.

## SHOULD
- Avoid `ICommandWithTimestamp` on query objects — has no meaning for reads.
- Avoid `ICommandWithTimestamp` defined in BuildingBlocks — forces module Interfaces to reference BuildingBlocks.
