...
- Never be implemented by `External Immutable` or `Internal Immutable` entities.
...
- Avoid adding update timestamps to an entity that is never updated.
