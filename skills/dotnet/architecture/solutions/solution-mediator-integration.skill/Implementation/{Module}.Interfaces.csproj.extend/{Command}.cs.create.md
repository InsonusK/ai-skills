...
Each of steps 2–4 appears only when its VP applies; the relative order is what is fixed. See the [delta-conflict analysis](skills/dotnet/architecture/delta-conflict-analysis.md#command-cs) for why (`FMC` between VP6 and VP7, resolved by convention).
