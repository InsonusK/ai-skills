...
- Never redefine table names, column names, or indexes already owned by Domain config
- Never configure intra-module relationships here
- Never configure cross-module foreign keys in Domain config
