...
The entity provides a guarded mutation method for the service to call — see `{Entity}.cs.create.md` in this solution.
...
- Never introduce a new uncoordinated public mutation point for an entity property
- Never depend on EF Core, FluentValidation, ASP.NET, HttpContext, or any infrastructure
- Never hold instance state
