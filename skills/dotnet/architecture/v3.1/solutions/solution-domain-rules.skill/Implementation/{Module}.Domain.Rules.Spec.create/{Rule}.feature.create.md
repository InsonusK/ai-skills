...
- Never reference a specific layer's type (`SoftComplexity`, `ComplexityPropertyValidator`) in the Gherkin text itself — keep the feature file layer-agnostic; the step definition is what's layer-specific
