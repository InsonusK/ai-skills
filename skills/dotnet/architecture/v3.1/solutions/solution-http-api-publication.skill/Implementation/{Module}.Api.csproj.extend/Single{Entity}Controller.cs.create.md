...
- Never return the updated entity body from `Update`
- Never perform business validation of the route/body id match beyond equality — anything deeper belongs in the command validator
