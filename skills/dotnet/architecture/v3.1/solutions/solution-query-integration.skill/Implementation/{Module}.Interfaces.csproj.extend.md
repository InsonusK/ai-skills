...
- Never queries contain any logic or methods
- Never DTOs expose domain entity types — projection shapes only
- Never DTOs have public setters — declared as `record` for immutability

## SHOULD
- Avoid query declared in Application — Interfaces is the public contract surface
- Avoid DTO with domain entity property — breaks layer isolation
