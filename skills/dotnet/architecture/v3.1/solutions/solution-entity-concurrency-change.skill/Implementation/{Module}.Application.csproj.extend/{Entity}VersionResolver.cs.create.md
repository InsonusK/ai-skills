...
- Never throw when entity is missing

## SHOULD
- Avoid duplicating the `{Entity}ByIdSpec` query inline in the resolver — reuse the spec
- Avoid hardcoding entity name strings that differ from the config constant
