...
## Project Structure
- /{ModuleName}.Api
  - /Http/[{Entity}Endpoints.cs](./classes/plateau-domain-service--class-endpoint.skill.md)
...
| --- | --- | --- |
| /Http/{Entity}Endpoints.cs | Minimal-API/controller endpoints dispatching via `ISender` | [[./classes/plateau-domain-service--class-endpoint.skill.md\|class-endpoint]] |
