---
name: plateau-domain-service--class-command
description: Class {Command} in the plateau-domain-service plateau — a module's write-intent record (with its {Command}Result) in {Module}.Interfaces/Commands
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-command
// Plateau: core
// Version: 20260902000000
