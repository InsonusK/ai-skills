...
- /{ModuleName}.Interfaces
  - /Commands
    - [{Command}.cs](./classes/plateau-domain-service--class-command.skill.md) — command record + `{Command}Result` record
  - /Queries
    - [{Query}.cs](./classes/plateau-domain-service--class-query.skill.md) — query record + response DTO
  - /Events
    - [{Event}.cs](./classes/plateau-domain-service--class-event.skill.md) — past-tense `INotificationEvent`
  - /DTOs — response shapes shared by several queries
  - /ValueObjects
    - [Soft{ValueObject}.cs](./classes/plateau-domain-service--class-soft-value-object.skill.md) — permissive value record
  - {ModuleName}.Interfaces.csproj

## Directory and class skills
| `Directory\|file` | Description | Pattern skill |
| --- | --- | --- |
| /Commands/{Command}.cs | Write-intent record + result record | [[./classes/plateau-domain-service--class-command.skill.md\|class-command]] |
| /Queries/{Query}.cs | Read-intent record + response DTO | [[./classes/plateau-domain-service--class-query.skill.md\|class-query]] |
| /Events/{Event}.cs | Domain fact as a notification | [[./classes/plateau-domain-service--class-event.skill.md\|class-event]] |
| /ValueObjects/Soft{ValueObject}.cs | Permissive value record | [[./classes/plateau-domain-service--class-soft-value-object.skill.md\|class-soft-value-object]] |
...
- Handlers, validators — belong to [[../{Module}.Application/plateau-domain-service--csproj-module-application.skill.md|{Module}.Application]].
