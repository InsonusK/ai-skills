...
- /Shared.Tests
  - /Rules/{Rule}.feature
  - /StepDefinitions/[{Rule}Steps.cs](./classes/plateau-domain-service--class-shared-rule-steps.skill.md)
  - reqnroll.json
  - Shared.Tests.csproj
...
| /StepDefinitions/{Rule}Steps.cs | Bindings asserting against the real `Shared` type | [[./classes/plateau-domain-service--class-shared-rule-steps.skill.md\|class-shared-rule-steps]] |
