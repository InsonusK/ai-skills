...
- /{ModuleName}.Application
  - /Features/{FeatureName}
    - [{FeatureName}.Handler.cs](./classes/plateau-domain-service--class-feature-handler.skill.md)
    - [{FeatureName}.Validator.cs](./classes/plateau-domain-service--class-feature-validator.skill.md)
  - /Events/{EventName}
    - [{EventName}.EventHandler.cs](./classes/plateau-domain-service--class-event-handler.skill.md)
  - /Validators
...
| --- | --- | --- |
| /Features/{FeatureName}/{FeatureName}.Handler.cs | Command or query handler | [[./classes/plateau-domain-service--class-feature-handler.skill.md\|class-feature-handler]] |
| /Features/{FeatureName}/{FeatureName}.Validator.cs | Per-feature transport validator | [[./classes/plateau-domain-service--class-feature-validator.skill.md\|class-feature-validator]] |
| /Events/{EventName}/{EventName}.EventHandler.cs | Notification handler | [[./classes/plateau-domain-service--class-event-handler.skill.md\|class-event-handler]] |
...
- Pipeline behaviors and their registration — belong to [[../App.Host/plateau-domain-service--csproj-app-host.skill.md|App.Host]].
