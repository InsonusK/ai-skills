...
- /{Module}.Application.Tests
  - /Rules/{Rule}.feature
  - /StepDefinitions/[{Rule}Steps.cs](./classes/plateau-domain-service--class-module-application-rule-steps.skill.md)
  - reqnroll.json
...
| /StepDefinitions/{Rule}Steps.cs | Bindings driving the real handler / validator | [[./classes/plateau-domain-service--class-module-application-rule-steps.skill.md\|class-module-application-rule-steps]] |
