---
name: plateau-domain-service--class-module-application-rule-steps
description: Class {Rule}Steps in {Module}.Application.Tests of the plateau-domain-service plateau — Reqnroll bindings driving a real handler or validator and asserting its Result
