...
- /{Module}.Domain.Tests
  - /Rules/{Rule}.feature
  - /StepDefinitions/[{Rule}Steps.cs](./classes/plateau-domain-service--class-module-domain-rule-steps.skill.md)
  - reqnroll.json
...
| --- | --- | --- |
| /StepDefinitions/{Rule}Steps.cs | Bindings asserting entity/VO behavior against the real types | [[./classes/plateau-domain-service--class-module-domain-rule-steps.skill.md\|class-module-domain-rule-steps]] |
