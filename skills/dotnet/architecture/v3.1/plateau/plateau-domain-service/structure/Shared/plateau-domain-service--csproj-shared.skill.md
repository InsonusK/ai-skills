...
- /Shared
  - /MediatR
    - [ICommand.cs](./classes/plateau-domain-service--class-i-command.skill.md) — `ICommand : IRequest<Result>`, `ICommand<TResponse> : IRequest<TResponse>`
    - [IQuery.cs](./classes/plateau-domain-service--class-i-query.skill.md) — `IQuery<TResponse> : IRequest<TResponse>`
...
| --- | --- | --- |
| /MediatR/ICommand.cs | `ICommand` + `ICommand<TResponse>` request markers | [[./classes/plateau-domain-service--class-i-command.skill.md\|class-i-command]] |
...
- Pipeline behaviors — belong to [[../BuildingBlocks/plateau-domain-service--csproj-building-blocks.skill.md|BuildingBlocks]].
- The logging provider configuration — belongs to [[../App.Host/classes/plateau-domain-service--class-logging-registration.skill.md|LoggingRegistration.cs]].
