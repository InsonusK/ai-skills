...
- Behavior order is not decided here — it lives in `App.Host`'s [[../App.Host/classes/plateau-domain-service--class-pipeline-registration.skill.md|PipelineRegistration]].
...
- Module-specific handlers/validators — belong to [[../{Module}.Application/plateau-domain-service--csproj-module-application.skill.md|{Module}.Application]].
- Cross-cutting contract definitions (`ICommand`, `IUnitOfWork`, …) — belong to [[../Shared/plateau-domain-service--csproj-shared.skill.md|Shared]].
