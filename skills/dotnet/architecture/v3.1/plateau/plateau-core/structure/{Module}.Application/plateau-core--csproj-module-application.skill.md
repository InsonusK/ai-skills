...
- /{ModuleName}.Application
  - /Features/{FeatureName}
    - [{FeatureName}.Handler.cs](./classes/plateau-core--class-feature-handler.skill.md)
    - [{FeatureName}.Validator.cs](./classes/plateau-core--class-feature-validator.skill.md)
  - /Events/{EventName}
    - [{EventName}.EventHandler.cs](./classes/plateau-core--class-event-handler.skill.md)
  - /Validators
    - /Property/[{ValueObject}PropertyValidator.cs](./classes/plateau-core--class-value-object-property-validator.skill.md)
    - /Model/[{Dto}.Validator.cs](./classes/plateau-core--class-dto-validator.skill.md)
    - /Async/[{Feature}Check.cs](./classes/plateau-core--class-feature-check.skill.md) — `Load` throws until VP2
  - /Specifications — empty until VP2
  - [{ModuleName}ApplicationRegistration.cs](./classes/plateau-core--class-module-application-registration.skill.md)
  - {ModuleName}.Application.csproj

## Directory and class skills
| `Directory\|file` | Description | Pattern skill |
| --- | --- | --- |
| /Features/{FeatureName}/{FeatureName}.Handler.cs | Command or query handler | [[./classes/plateau-core--class-feature-handler.skill.md\|class-feature-handler]] |
| /Features/{FeatureName}/{FeatureName}.Validator.cs | Per-feature transport validator | [[./classes/plateau-core--class-feature-validator.skill.md\|class-feature-validator]] |
| /Events/{EventName}/{EventName}.EventHandler.cs | Notification handler | [[./classes/plateau-core--class-event-handler.skill.md\|class-event-handler]] |
| /Validators/Property/{ValueObject}PropertyValidator.cs | Reusable `Soft{ValueObject}` validator | [[./classes/plateau-core--class-value-object-property-validator.skill.md\|class-value-object-property-validator]] |
| /Validators/Model/{Dto}.Validator.cs | Reusable RequestDto validator | [[./classes/plateau-core--class-dto-validator.skill.md\|class-dto-validator]] |
| /Validators/Async/{Feature}Check.cs | Async cross-aggregate check seam | [[./classes/plateau-core--class-feature-check.skill.md\|class-feature-check]] |
| {ModuleName}ApplicationRegistration.cs | Module DI self-registration | [[./classes/plateau-core--class-module-application-registration.skill.md\|class-module-application-registration]] |
...
- Pipeline behaviors and their registration — belong to [[../App.Host/plateau-core--csproj-app-host.skill.md|App.Host]].
