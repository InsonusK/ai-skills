...
- /BuildingBlocks.Tests
  - /Rules/{Rule}.feature
  - /StepDefinitions/[{Rule}Steps.cs](./classes/plateau-core--class-building-blocks-rule-steps.skill.md)
  - reqnroll.json
...
| /StepDefinitions/{Rule}Steps.cs | Bindings driving the real behavior | [[./classes/plateau-core--class-building-blocks-rule-steps.skill.md\|class-building-blocks-rule-steps]] |
