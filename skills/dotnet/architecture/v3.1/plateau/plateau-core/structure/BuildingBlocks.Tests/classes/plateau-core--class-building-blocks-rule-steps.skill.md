---
name: plateau-core--class-building-blocks-rule-steps
description: Class {Rule}Steps in BuildingBlocks.Tests of the plateau-core plateau — Reqnroll bindings driving a real pipeline behavior and asserting the returned Result
