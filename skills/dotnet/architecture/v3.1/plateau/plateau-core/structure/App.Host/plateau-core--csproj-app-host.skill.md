...
- /App.Host
  - /DependencyInjection
    - [ModuleRegistration.cs](./classes/plateau-core--class-module-registration.skill.md) — `AddModules()`
    - [PipelineRegistration.cs](./classes/plateau-core--class-pipeline-registration.skill.md) — `AddPipeline()`, behavior order
    - [LoggingRegistration.cs](./classes/plateau-core--class-logging-registration.skill.md) — `AddAppLogging()`
...
| --- | --- | --- |
| /DependencyInjection/ModuleRegistration.cs | `AddModules()` — every module's registration | [[./classes/plateau-core--class-module-registration.skill.md\|class-module-registration]] |
| /DependencyInjection/PipelineRegistration.cs | `AddPipeline()` — pipeline behavior order | [[./classes/plateau-core--class-pipeline-registration.skill.md\|class-pipeline-registration]] |
| /DependencyInjection/LoggingRegistration.cs | `AddAppLogging()` — provider + levels | [[./classes/plateau-core--class-logging-registration.skill.md\|class-logging-registration]] |
