...
- /{Module}.Interfaces.Tests
  - /Rules/{Rule}.feature
  - /StepDefinitions/[{Rule}Steps.cs](./classes/plateau-core--class-module-interfaces-rule-steps.skill.md)
  - reqnroll.json
...
| /StepDefinitions/{Rule}Steps.cs | Bindings constructing and inspecting the real contract types | [[./classes/plateau-core--class-module-interfaces-rule-steps.skill.md\|class-module-interfaces-rule-steps]] |
