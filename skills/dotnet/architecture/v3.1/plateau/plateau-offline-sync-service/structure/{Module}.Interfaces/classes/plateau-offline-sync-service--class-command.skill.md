---
name: plateau-offline-sync-service--class-command
description: Class {Command} in the plateau-offline-sync-service plateau — a module's write-intent record (with its {Command}Result) in {Module}.Interfaces/Commands
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-command
// Plateau: core
// Version: 20260902000000
