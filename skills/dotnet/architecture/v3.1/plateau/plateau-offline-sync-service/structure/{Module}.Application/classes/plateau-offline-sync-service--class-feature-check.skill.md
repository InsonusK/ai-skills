---
name: plateau-offline-sync-service--class-feature-check
description: Class {Feature}Check in the plateau-offline-sync-service plateau — the DI-injected async cross-aggregate check seam; its Load step has no data source until VP2
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-feature-check
// Plateau: core
// Version: 20260902000000
