...
- /BuildingBlocks.Tests
  - /Rules/{Rule}.feature
  - /StepDefinitions/[{Rule}Steps.cs](./classes/plateau-offline-sync-service--class-building-blocks-rule-steps.skill.md)
  - reqnroll.json
...
| /StepDefinitions/{Rule}Steps.cs | Bindings driving the real behavior | [[./classes/plateau-offline-sync-service--class-building-blocks-rule-steps.skill.md\|class-building-blocks-rule-steps]] |
