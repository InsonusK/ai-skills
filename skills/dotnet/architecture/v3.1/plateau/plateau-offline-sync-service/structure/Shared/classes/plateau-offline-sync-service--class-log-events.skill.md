---
name: plateau-offline-sync-service--class-log-events
description: Class LogEvents in the plateau-offline-sync-service plateau — the static catalogue of stable EventId constants for searched-for log lines, in Shared/Logging
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-log-events
// Plateau: core
// Version: 20260902000000
