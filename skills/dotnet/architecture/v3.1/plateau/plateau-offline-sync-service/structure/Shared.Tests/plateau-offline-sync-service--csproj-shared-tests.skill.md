---
name: plateau-offline-sync-service--csproj-shared-tests
description: Project Shared.Tests in the plateau-offline-sync-service plateau — the dedicated test project for Shared, referencing Shared only
...
- /Shared.Tests
  - /Rules/{Rule}.feature
  - /StepDefinitions/[{Rule}Steps.cs](./classes/plateau-offline-sync-service--class-shared-rule-steps.skill.md)
  - reqnroll.json
  - Shared.Tests.csproj
...
| /StepDefinitions/{Rule}Steps.cs | Bindings asserting against the real `Shared` type | [[./classes/plateau-offline-sync-service--class-shared-rule-steps.skill.md\|class-shared-rule-steps]] |
