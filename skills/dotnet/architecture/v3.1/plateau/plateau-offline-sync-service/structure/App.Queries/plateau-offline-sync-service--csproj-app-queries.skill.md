...
## Project Structure
- /App.Queries
  - /Specifications/[{Thing}ProjectionSpec.cs](./classes/plateau-offline-sync-service--class-cross-module-projection-spec.skill.md)
...
| --- | --- | --- |
| /Specifications/{Thing}ProjectionSpec.cs | Cross-module JOIN → read DTO | [[./classes/plateau-offline-sync-service--class-cross-module-projection-spec.skill.md\|class-cross-module-projection-spec]] |
