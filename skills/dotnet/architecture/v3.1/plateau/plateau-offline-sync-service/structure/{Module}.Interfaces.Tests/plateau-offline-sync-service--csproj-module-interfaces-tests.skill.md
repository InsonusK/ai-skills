---
name: plateau-offline-sync-service--csproj-module-interfaces-tests
description: Project {Module}.Interfaces.Tests in the plateau-offline-sync-service plateau — the dedicated test project for {Module}.Interfaces, referencing that module's Interfaces only
...
- /{Module}.Interfaces.Tests
  - /Rules/{Rule}.feature
  - /StepDefinitions/[{Rule}Steps.cs](./classes/plateau-offline-sync-service--class-module-interfaces-rule-steps.skill.md)
  - reqnroll.json
...
| /StepDefinitions/{Rule}Steps.cs | Bindings constructing and inspecting the real contract types | [[./classes/plateau-offline-sync-service--class-module-interfaces-rule-steps.skill.md\|class-module-interfaces-rule-steps]] |
