...
## Project Structure
- /App.Infrastructure
  - /Persistence/[AppDbContext.cs](./classes/plateau-offline-sync-service--class-app-dbcontext.skill.md), /Persistence/Configurations/{Module1}To{Module2}Config.cs
  - /Repositories/[Repository.cs](./classes/plateau-offline-sync-service--class-repository.skill.md)
  - /UnitOfWork/[UnitOfWork.cs](./classes/plateau-offline-sync-service--class-unit-of-work.skill.md)
  - /Concurrency/[EntityVersionResolverFactory.cs](./classes/plateau-offline-sync-service--class-entity-version-resolver-factory.skill.md)
  - /Protos/{Dependency}.proto, /Clients/[{Dependency}GrpcClient.cs](./classes/plateau-offline-sync-service--class-dependency-grpc-client.skill.md), /Clients/[GrpcStatusExtensions.cs](./classes/plateau-offline-sync-service--class-grpc-status-extensions.skill.md)
  - App.Infrastructure.csproj

## Directory and class skills
| `Directory\|file` | Description | Pattern skill |
| --- | --- | --- |
| /Persistence/AppDbContext.cs | The service's single `DbContext` | [[./classes/plateau-offline-sync-service--class-app-dbcontext.skill.md\|class-app-dbcontext]] |
| /Repositories/Repository.cs | Generic Ardalis-backed repository | [[./classes/plateau-offline-sync-service--class-repository.skill.md\|class-repository]] |
| /UnitOfWork/UnitOfWork.cs | The single `SaveChangesAsync` call site | [[./classes/plateau-offline-sync-service--class-unit-of-work.skill.md\|class-unit-of-work]] |
| /Concurrency/EntityVersionResolverFactory.cs | Name → resolver map (assembly scan) | [[./classes/plateau-offline-sync-service--class-entity-version-resolver-factory.skill.md\|class-entity-version-resolver-factory]] |
| /Clients/{Dependency}GrpcClient.cs | Generated stub wrapped as `I{Dependency}Client` | [[./classes/plateau-offline-sync-service--class-dependency-grpc-client.skill.md\|class-dependency-grpc-client]] |
| /Clients/GrpcStatusExtensions.cs | `RpcException` → `Result` mapping | [[./classes/plateau-offline-sync-service--class-grpc-status-extensions.skill.md\|class-grpc-status-extensions]] |
