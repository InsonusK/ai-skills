...
problem: Pick one Gherkin/BDD runner, one coverage tool, and one mutation-testing tool for .NET projects that must satisfy the solution-conformance-testing gate
