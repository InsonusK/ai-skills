---
name: plateau-core--class-exception-handling-behavior
description: Class ExceptionHandlingBehavior<TRequest, TResponse> in the plateau-core plateau — the first pipeline behavior; catches every unhandled exception, logs it Critical, returns a generic Result.Error
...
# Implementation
```csharp
// Skill: plateau-core--class-exception-handling-behavior
// Plateau: core
// Version: 20260902000000
