---
name: plateau-core--class-event
description: Class {Event} in the plateau-core plateau — a module's past-tense domain-fact record in {Module}.Interfaces/Events
...
# Implementation
```csharp
// Skill: plateau-core--class-event
// Plateau: core
// Version: 20260902000000
