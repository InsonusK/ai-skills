---
name: plateau-core--class-query
description: Class {Query} in the plateau-core plateau — a module's read-intent record (with its response DTO) in {Module}.Interfaces/Queries
...
# Implementation
```csharp
// Skill: plateau-core--class-query
// Plateau: core
// Version: 20260902000000
