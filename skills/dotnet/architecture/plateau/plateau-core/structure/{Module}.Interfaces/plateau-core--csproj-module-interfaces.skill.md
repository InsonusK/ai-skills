---
name: plateau-core--csproj-module-interfaces
description: Project {Module}.Interfaces in the plateau-core plateau — a module's only public surface (commands, queries, notifications, DTOs, Soft Value Objects), declarations only
...
- /{ModuleName}.Interfaces
  - /Commands
    - [{Command}.cs](skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Interfaces/classes/plateau-core--class-command.skill.md) — command record + `{Command}Result` record
  - /Queries
    - [{Query}.cs](skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Interfaces/classes/plateau-core--class-query.skill.md) — query record + response DTO
  - /Events
    - [{Event}.cs](skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Interfaces/classes/plateau-core--class-event.skill.md) — past-tense `INotificationEvent`
  - /DTOs — response shapes shared by several queries
  - /ValueObjects
    - [Soft{ValueObject}.cs](skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Interfaces/classes/plateau-core--class-soft-value-object.skill.md) — permissive value record
  - {ModuleName}.Interfaces.csproj

## Directory and class skills
| `Directory\|file` | Description | Pattern skill |
| --- | --- | --- |
| /Commands/{Command}.cs | Write-intent record + result record | [[skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Interfaces/classes/plateau-core--class-command.skill\|class-command]] |
| /Queries/{Query}.cs | Read-intent record + response DTO | [[skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Interfaces/classes/plateau-core--class-query.skill\|class-query]] |
| /Events/{Event}.cs | Domain fact as a notification | [[skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Interfaces/classes/plateau-core--class-event.skill\|class-event]] |
| /ValueObjects/Soft{ValueObject}.cs | Permissive value record | [[skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Interfaces/classes/plateau-core--class-soft-value-object.skill\|class-soft-value-object]] |
...
- Handlers, validators — belong to [[skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Application/plateau-core--csproj-module-application.skill|{Module}.Application]].
