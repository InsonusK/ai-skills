---
name: plateau-core--class-feature-validator
description: Class {FeatureName}Validator in the plateau-core plateau — the per-feature transport-correctness validator co-located with its handler
...
# Implementation
```csharp
// Skill: plateau-core--class-feature-validator
// Plateau: core
// Version: 20260902000000
