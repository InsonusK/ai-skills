---
name: plateau-core--class-module-application-registration
description: Class {Module}ApplicationRegistration in the plateau-core plateau — the module's one DI self-registration extension (AddMediatR + AddValidatorsFromAssembly)
...
# Implementation
```csharp
// Skill: plateau-core--class-module-application-registration
// Plateau: core
// Version: 20260902000000
