---
name: plateau-core--csproj-module-application
description: Project {Module}.Application in the plateau-core plateau — orchestration only (command/query handlers, per-feature validators, reusable property/DTO validators, module DI self-registration)
...
- /{ModuleName}.Application
  - /Features/{FeatureName}
    - [{FeatureName}.Handler.cs](skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Application/classes/plateau-core--class-feature-handler.skill.md)
    - [{FeatureName}.Validator.cs](skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Application/classes/plateau-core--class-feature-validator.skill.md)
  - /Events/{EventName}
    - [{EventName}.EventHandler.cs](skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Application/classes/plateau-core--class-event-handler.skill.md)
  - /Validators
...
| --- | --- | --- |
| /Features/{FeatureName}/{FeatureName}.Handler.cs | Command or query handler | [[skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Application/classes/plateau-core--class-feature-handler.skill\|class-feature-handler]] |
| /Features/{FeatureName}/{FeatureName}.Validator.cs | Per-feature transport validator | [[skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Application/classes/plateau-core--class-feature-validator.skill\|class-feature-validator]] |
| /Events/{EventName}/{EventName}.EventHandler.cs | Notification handler | [[skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Application/classes/plateau-core--class-event-handler.skill\|class-event-handler]] |
| /Validators/Property/{ValueObject}PropertyValidator.cs | Reusable `Soft{ValueObject}` validator | [[skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Application/classes/plateau-core--class-value-object-property-validator.skill\|class-value-object-property-validator]] |
| /Validators/Model/{Dto}.Validator.cs | Reusable RequestDto validator | [[skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Application/classes/plateau-core--class-dto-validator.skill\|class-dto-validator]] |
| /Validators/Async/{Feature}Check.cs | Async cross-aggregate check seam | [[skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Application/classes/plateau-core--class-feature-check.skill\|class-feature-check]] |
| {ModuleName}ApplicationRegistration.cs | Module DI self-registration | [[skills/dotnet/architecture/plateau/plateau-core/structure/{Module}.Application/classes/plateau-core--class-module-application-registration.skill\|class-module-application-registration]] |
