...
description: Project BuildingBlocks.Tests in the plateau-core plateau — the dedicated test project for BuildingBlocks (and transitively Shared)
...
- /BuildingBlocks.Tests
  - /Rules/{Rule}.feature
  - /StepDefinitions/[{Rule}Steps.cs](skills/dotnet/architecture/plateau/plateau-core/structure/BuildingBlocks.Tests/classes/plateau-core--class-building-blocks-rule-steps.skill.md)
  - reqnroll.json
...
| /StepDefinitions/{Rule}Steps.cs | Bindings driving the real behavior | [[skills/dotnet/architecture/plateau/plateau-core/structure/BuildingBlocks.Tests/classes/plateau-core--class-building-blocks-rule-steps.skill\|class-building-blocks-rule-steps]] |
