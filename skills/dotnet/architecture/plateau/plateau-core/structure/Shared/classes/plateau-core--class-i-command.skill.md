---
name: plateau-core--class-i-command
description: Class ICommand / ICommand<TResponse> in the plateau-core plateau — the write-intent request markers in Shared/MediatR
...
# Implementation
```csharp
// Skill: plateau-core--class-i-command
// Plateau: core
// Version: 20260902000000
