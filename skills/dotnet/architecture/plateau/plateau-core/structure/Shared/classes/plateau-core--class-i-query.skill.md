---
name: plateau-core--class-i-query
description: Class IQuery<TResponse> in the plateau-core plateau — the read-intent request marker in Shared/MediatR
...
# Implementation
```csharp
// Skill: plateau-core--class-i-query
// Plateau: core
// Version: 20260902000000
using MediatR;
