---
name: plateau-core--csproj-app-host
description: Project App.Host in the plateau-core plateau — the single composition root wiring logging, modules, and the MediatR pipeline; contains only wiring
...
- /App.Host
  - /DependencyInjection
    - [ModuleRegistration.cs](skills/dotnet/architecture/plateau/plateau-core/structure/App.Host/classes/plateau-core--class-module-registration.skill.md) — `AddModules()`
    - [PipelineRegistration.cs](skills/dotnet/architecture/plateau/plateau-core/structure/App.Host/classes/plateau-core--class-pipeline-registration.skill.md) — `AddPipeline()`, behavior order
    - [LoggingRegistration.cs](skills/dotnet/architecture/plateau/plateau-core/structure/App.Host/classes/plateau-core--class-logging-registration.skill.md) — `AddAppLogging()`
...
| --- | --- | --- |
| /DependencyInjection/ModuleRegistration.cs | `AddModules()` — every module's registration | [[skills/dotnet/architecture/plateau/plateau-core/structure/App.Host/classes/plateau-core--class-module-registration.skill\|class-module-registration]] |
| /DependencyInjection/PipelineRegistration.cs | `AddPipeline()` — pipeline behavior order | [[skills/dotnet/architecture/plateau/plateau-core/structure/App.Host/classes/plateau-core--class-pipeline-registration.skill\|class-pipeline-registration]] |
| /DependencyInjection/LoggingRegistration.cs | `AddAppLogging()` — provider + levels | [[skills/dotnet/architecture/plateau/plateau-core/structure/App.Host/classes/plateau-core--class-logging-registration.skill\|class-logging-registration]] |
