---
name: plateau-core--class-module-registration
description: Class ModuleRegistration in the plateau-core plateau — the one AddModules() extension where every module's Register{ModuleName}Module is called
...
# Implementation
```csharp
// Skill: plateau-core--class-module-registration
// Plateau: core
// Version: 20260902000000
