---
name: plateau-core--class-logging-registration
description: Class LoggingRegistration in the plateau-core plateau — the one AddAppLogging() extension where the logging provider and level filters are configured
...
# Implementation
```csharp
// Skill: plateau-core--class-logging-registration
// Plateau: core
// Version: 20260902000000
