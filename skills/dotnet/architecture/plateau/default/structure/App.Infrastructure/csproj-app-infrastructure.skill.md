...
- [[skills/dotnet/architecture/solutions/🧩validated/solution-unit-of-work.skill/solution-unit-of-work.skill|class-unit-of-work]] - [[skills/dotnet/architecture/solutions/🧩validated/solution-unit-of-work.skill/Implementation/App.Infrastructure.csproj.extend|App.Infrastructure.csproj]]
- [[skills/dotnet/architecture/solutions/🧩validated/solution-sln-structure.skill/solution-sln-structure.skill|solution-sln-structure]] - [[skills/dotnet/architecture/solutions/🧩validated/solution-sln-structure.skill/Implementation/App.Infrastructure.csproj.create|App.Infrastructure.csproj]]
- [[skills/dotnet/architecture/solutions/🧩validated/solution-repository-integration.skill/solution-repository-integration.skill|solution-repository-integration]] - [[skills/dotnet/architecture/solutions/🧩validated/solution-repository-integration.skill/Implementation/App.Infrastructure.csproj.extend|App.Infrastructure.csproj]]
- [[skills/dotnet/architecture/solutions/🧩validated/solution-entity-concurrency-change.skill/solution-entity-concurrency-change.skill|solution-entity-concurrency-change]] - [[skills/dotnet/architecture/solutions/🧩validated/solution-entity-concurrency-change.skill/Implementation/App.Infrastructure.csproj.extend|App.Infrastructure.csproj]]
...
- [[skills/dotnet/architecture/solutions/🧩validated/solution-entity-edit-timestamp.skill/solution-entity-edit-timestamp.skill|solution-entity-edit-timestamp]] - [[skills/dotnet/architecture/solutions/🧩validated/solution-entity-edit-timestamp.skill/Implementation/App.Infrastructure.csproj.extend|App.Infrastructure.csproj]]
...
- /App.Infrastructure
  - /Persistence
    - AppDbContext.cs
    - /Configurations
      - [CrossModuleFkConfig.cs](skills/dotnet/architecture/plateau/default/structure/App.Infrastructure/classes/class-module-to-module-config.skill.md)
      - OutboxMessageConfig.cs
  - /Repositories
    - [Repository.cs](skills/dotnet/architecture/plateau/default/structure/App.Infrastructure/classes/class-repository.skill.md)
  - /UnitOfWork
    - [UnitOfWork.cs](skills/dotnet/architecture/plateau/default/structure/App.Infrastructure/classes/class-unit-of-work.skill.md)
  - /Outbox
    - DomainEventInterceptor.cs
    - OutboxDispatcher.cs
  - /Concurrency
    - [EntityVersionResolverFactory.cs](skills/dotnet/architecture/plateau/default/structure/App.Infrastructure/classes/class-entity-version-resolver-factory.skill.md)
...
| -------------------------------------------- | -------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| /UnitOfWork                                  | Unit of work implementations                                                           | [[skills/dotnet/architecture/plateau/default/structure/App.Infrastructure/classes/class-unit-of-work.skill\|class-UnitOfWork.skill]]                                      |
| UnitOfWork.cs                                | EF Core SaveChangesAsync implementation                                                | [[skills/dotnet/architecture/plateau/default/structure/App.Infrastructure/classes/class-unit-of-work.skill\|class-UnitOfWork.skill]]                                      |
| /Persistence                                 | DbContext and EF configurations                                                        |                                                                                                                                                                                     |
| /Repositories                                | Generic Repository<T> implementation                                                   |                                                                                                                                                                                     |
| /UnitOfWork                                  | UnitOfWork implementation                                                              | [[skills/dotnet/architecture/plateau/default/structure/App.Infrastructure/classes/class-unit-of-work.skill\|class-UnitOfWork.skill]]                                      |
...
| /Repositories/Repository.cs                  | Generic EF Core repository implementation inheriting Ardalis `RepositoryBase<T>`       | [[skills/dotnet/architecture/plateau/default/structure/App.Infrastructure/classes/class-repository.skill\|class-Repository.skill]]                                        |
| /Concurrency/EntityVersionResolverFactory.cs | Maps string entity names to Application-layer `IEntityVersionResolver` implementations | [[skills/dotnet/architecture/plateau/default/structure/App.Infrastructure/classes/class-entity-version-resolver-factory.skill\|class-EntityVersionResolverFactory.skill]] |
