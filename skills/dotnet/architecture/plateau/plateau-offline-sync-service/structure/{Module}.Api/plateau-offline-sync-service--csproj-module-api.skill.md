...
## Project Structure
- /{ModuleName}.Api
  - /Http/[{Entity}Endpoints.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/{Module}.Api/classes/plateau-offline-sync-service--class-endpoint.skill.md)
...
| --- | --- | --- |
| /Http/{Entity}Endpoints.cs | Minimal-API/controller endpoints dispatching via `ISender` | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/{Module}.Api/classes/plateau-offline-sync-service--class-endpoint.skill\|class-endpoint]] |
