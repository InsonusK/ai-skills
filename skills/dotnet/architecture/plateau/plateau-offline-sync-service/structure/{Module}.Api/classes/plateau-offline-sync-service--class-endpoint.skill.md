---
name: plateau-offline-sync-service--class-endpoint
description: Class {Entity}Endpoints in the plateau-offline-sync-service plateau — a thin HTTP adapter that maps a request to a Command/Query, dispatches via ISender, maps the Result to a status
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-endpoint
...
__Applied solutions:__
- [[skills/dotnet/architecture/solutions/solution-entity-concurrency-change.skill/solution-entity-concurrency-change.skill|solution-entity-concurrency-change]] - [[skills/dotnet/architecture/solutions/solution-entity-concurrency-change.skill/Implementation/{Module}.Api.csproj.extend/Single{Entity}Controller.cs.extend|Single{Entity}Controller.cs]]
