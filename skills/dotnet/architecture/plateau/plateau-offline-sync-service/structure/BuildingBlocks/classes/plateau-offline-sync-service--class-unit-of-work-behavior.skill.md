---
name: plateau-offline-sync-service--class-unit-of-work-behavior
description: Class UnitOfWorkBehavior<TRequest, TResponse> in the plateau-offline-sync-service plateau — the last pipeline behavior; commits all staged changes once, after the outermost command handler completes
...
- [[skills/dotnet/architecture/solutions/solution-unit-of-work.skill/solution-unit-of-work.skill|solution-unit-of-work]] - [[skills/dotnet/architecture/solutions/solution-unit-of-work.skill/Implementation/BuildingBlocks.csproj.extend/UnitOfWorkBehavior.cs.create|UnitOfWorkBehavior.cs]]
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-unit-of-work-behavior
...
__Applied solutions:__
- [[skills/dotnet/architecture/solutions/solution-unit-of-work.skill/solution-unit-of-work.skill|solution-unit-of-work]] - [[skills/dotnet/architecture/solutions/solution-unit-of-work.skill/Implementation/App.Host.csproj.extend/PipelineRegistration.cs.extend|PipelineRegistration.cs]]
