---
name: plateau-offline-sync-service--class-unit-of-work-context
description: Class UnitOfWorkContext in the plateau-offline-sync-service plateau — the scoped, thread-safe nesting-depth counter that lets UnitOfWorkBehavior tell whether it is the outermost command
...
- [[skills/dotnet/architecture/solutions/solution-unit-of-work.skill/solution-unit-of-work.skill|solution-unit-of-work]] - [[skills/dotnet/architecture/solutions/solution-unit-of-work.skill/Implementation/BuildingBlocks.csproj.extend/UnitOfWorkContext.cs.create|UnitOfWorkContext.cs]]
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-unit-of-work-context
