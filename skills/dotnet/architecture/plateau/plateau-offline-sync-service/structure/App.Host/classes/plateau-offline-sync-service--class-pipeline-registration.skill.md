---
name: plateau-offline-sync-service--class-pipeline-registration
description: Class PipelineRegistration in the plateau-offline-sync-service plateau — the one AddPipeline() extension and the authoritative record of MediatR pipeline behavior order
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-pipeline-registration
// Plateau: core
// Version: 20260902000000
