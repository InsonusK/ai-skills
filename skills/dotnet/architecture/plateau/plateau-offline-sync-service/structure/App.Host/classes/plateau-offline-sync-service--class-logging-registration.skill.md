---
name: plateau-offline-sync-service--class-logging-registration
description: Class LoggingRegistration in the plateau-offline-sync-service plateau — the one AddAppLogging() extension where the logging provider and level filters are configured
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-logging-registration
// Plateau: core
// Version: 20260902000000
