---
name: plateau-offline-sync-service--class-api-registration
description: Class ApiRegistration in the plateau-offline-sync-service plateau — the App.Host AddModuleApi() / UseModuleApi() extension pair with static partial void hooks that each transport solution implements
...
- [[skills/dotnet/architecture/solutions/solution-api-project.skill/solution-api-project.skill|solution-api-project]] - [[skills/dotnet/architecture/solutions/solution-api-project.skill/Implementation/App.Host.csproj.extend/ApiRegistration.cs.create|ApiRegistration.cs]]
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-api-registration
