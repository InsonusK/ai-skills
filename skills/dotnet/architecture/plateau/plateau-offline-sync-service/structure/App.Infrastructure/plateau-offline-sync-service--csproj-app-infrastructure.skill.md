---
name: plateau-offline-sync-service--csproj-app-infrastructure
description: Project App.Infrastructure in the plateau-offline-sync-service plateau — the single home for outbound infrastructure (AppDbContext, generic repository, unit of work, concurrency version-resolver factory, gRPC client wrappers)
...
## Project Structure
- /App.Infrastructure
  - /Persistence/[AppDbContext.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/App.Infrastructure/classes/plateau-offline-sync-service--class-app-dbcontext.skill.md), /Persistence/Configurations/{Module1}To{Module2}Config.cs
  - /Repositories/[Repository.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/App.Infrastructure/classes/plateau-offline-sync-service--class-repository.skill.md)
  - /UnitOfWork/[UnitOfWork.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/App.Infrastructure/classes/plateau-offline-sync-service--class-unit-of-work.skill.md)
  - /Concurrency/[EntityVersionResolverFactory.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/App.Infrastructure/classes/plateau-offline-sync-service--class-entity-version-resolver-factory.skill.md)
  - /Protos/{Dependency}.proto, /Clients/[{Dependency}GrpcClient.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/App.Infrastructure/classes/plateau-offline-sync-service--class-dependency-grpc-client.skill.md), /Clients/[GrpcStatusExtensions.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/App.Infrastructure/classes/plateau-offline-sync-service--class-grpc-status-extensions.skill.md)
  - App.Infrastructure.csproj

## Directory and class skills
| `Directory\|file` | Description | Pattern skill |
| --- | --- | --- |
| /Persistence/AppDbContext.cs | The service's single `DbContext` | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/App.Infrastructure/classes/plateau-offline-sync-service--class-app-dbcontext.skill\|class-app-dbcontext]] |
| /Repositories/Repository.cs | Generic Ardalis-backed repository | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/App.Infrastructure/classes/plateau-offline-sync-service--class-repository.skill\|class-repository]] |
| /UnitOfWork/UnitOfWork.cs | The single `SaveChangesAsync` call site | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/App.Infrastructure/classes/plateau-offline-sync-service--class-unit-of-work.skill\|class-unit-of-work]] |
| /Concurrency/EntityVersionResolverFactory.cs | Name → resolver map (assembly scan) | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/App.Infrastructure/classes/plateau-offline-sync-service--class-entity-version-resolver-factory.skill\|class-entity-version-resolver-factory]] |
| /Clients/{Dependency}GrpcClient.cs | Generated stub wrapped as `I{Dependency}Client` | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/App.Infrastructure/classes/plateau-offline-sync-service--class-dependency-grpc-client.skill\|class-dependency-grpc-client]] |
| /Clients/GrpcStatusExtensions.cs | `RpcException` → `Result` mapping | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/App.Infrastructure/classes/plateau-offline-sync-service--class-grpc-status-extensions.skill\|class-grpc-status-extensions]] |
