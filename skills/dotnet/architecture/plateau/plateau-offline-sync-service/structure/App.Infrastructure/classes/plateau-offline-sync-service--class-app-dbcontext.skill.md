---
name: plateau-offline-sync-service--class-app-dbcontext
description: Class AppDbContext in the plateau-offline-sync-service plateau — the service's single DbContext, applying every module's entity configurations and setting server timestamps / concurrency tokens before save
...
- [[skills/dotnet/architecture/solutions/solution-repository-integration.skill/solution-repository-integration.skill|solution-repository-integration]] - [[skills/dotnet/architecture/solutions/solution-repository-integration.skill/Implementation/App.Infrastructure.csproj.extend/AppDbContext.cs.create|AppDbContext.cs]]
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-app-dbcontext
...
__Applied solutions:__
- [[skills/dotnet/architecture/solutions/solution-entity-edit-timestamp.skill/solution-entity-edit-timestamp.skill|solution-entity-edit-timestamp]] - [[skills/dotnet/architecture/solutions/solution-entity-edit-timestamp.skill/Implementation/App.Infrastructure.csproj.extend/AppDbContext.cs.extend|AppDbContext.cs]]
