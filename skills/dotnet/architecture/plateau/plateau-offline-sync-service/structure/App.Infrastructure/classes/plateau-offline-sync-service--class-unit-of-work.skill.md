---
name: plateau-offline-sync-service--class-unit-of-work
description: Class UnitOfWork in the plateau-offline-sync-service plateau — the IUnitOfWork implementation, the single place DbContext.SaveChangesAsync is called
...
- [[skills/dotnet/architecture/solutions/solution-unit-of-work.skill/solution-unit-of-work.skill|solution-unit-of-work]] - [[skills/dotnet/architecture/solutions/solution-unit-of-work.skill/Implementation/App.Infrastructure.csproj.extend/UnitOfWork.cs.create|UnitOfWork.cs]]
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-unit-of-work
