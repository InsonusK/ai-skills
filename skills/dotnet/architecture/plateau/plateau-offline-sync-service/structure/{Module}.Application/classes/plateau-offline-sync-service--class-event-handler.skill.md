---
name: plateau-offline-sync-service--class-event-handler
description: Class {EventName}EventHandler in the plateau-offline-sync-service plateau — a notification handler in {Module}.Application/Events, one per reacting concern
...
- [[skills/dotnet/architecture/solutions/solution-mediator-integration.skill/solution-mediator-integration.skill|solution-mediator-integration]] - [[skills/dotnet/architecture/solutions/solution-mediator-integration.skill/Implementation/{Module}.Application.csproj.extend/{EventName}.EventHandler.cs.create|{EventName}.EventHandler.cs]]
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-event-handler
// Plateau: core
// Version: 20260902000000
using MediatR;
