---
name: plateau-offline-sync-service--class-entity-byidspec
description: Class {Entity}ByIdSpec in the plateau-offline-sync-service plateau — the named Ardalis specification to load one entity by Id, in {Module}.Application/Specifications
...
- [[skills/dotnet/architecture/solutions/solution-repository-integration.skill/solution-repository-integration.skill|solution-repository-integration]] - [[skills/dotnet/architecture/solutions/solution-repository-integration.skill/Implementation/{Module}.Application.csproj.extend/{Entity}ByIdSpec.cs.create|{Entity}ByIdSpec.cs]]
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-entity-byidspec
