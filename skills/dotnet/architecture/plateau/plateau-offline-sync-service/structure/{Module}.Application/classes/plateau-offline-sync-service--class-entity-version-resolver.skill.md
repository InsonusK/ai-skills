---
name: plateau-offline-sync-service--class-entity-version-resolver
description: Class {Entity}VersionResolver in the plateau-offline-sync-service plateau — the per-entity IEntityVersionResolver implementation, reading one entity's current version via its {Entity}ByIdSpec
...
- [[skills/dotnet/architecture/solutions/solution-entity-concurrency-change.skill/solution-entity-concurrency-change.skill|solution-entity-concurrency-change]] - [[skills/dotnet/architecture/solutions/solution-entity-concurrency-change.skill/Implementation/{Module}.Application.csproj.extend/{Entity}VersionResolver.cs.create|{Entity}VersionResolver.cs]]
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-entity-version-resolver
