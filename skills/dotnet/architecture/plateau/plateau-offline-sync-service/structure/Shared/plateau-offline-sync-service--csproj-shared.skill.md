...
created_by:
  ...
  - "[[skills/dotnet/architecture/solutions/solution-entity-edit-timestamp.skill/solution-entity-edit-timestamp.skill|solution-entity-edit-timestamp]]"
...
- /Shared
  - /MediatR
    - [ICommand.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-i-command.skill.md) — `ICommand : IRequest<Result>`, `ICommand<TResponse> : IRequest<TResponse>`
    - [IQuery.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-i-query.skill.md) — `IQuery<TResponse> : IRequest<TResponse>`
    - [INotificationEvent.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-i-notification-event.skill.md) — `INotificationEvent : INotification`
  - /Logging
    - [LogEvents.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-log-events.skill.md) — stable `EventId` constants
  - /Exceptions
  ...
  - /Results
    - [ConflictResult.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-guid-contracts.skill.md) — `Result<T>` with Conflict status carrying the existing entity (VP6)
  - /Exceptions
    - [EntityNotLoadedException.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-entity-not-loaded-exception.skill.md) — required-navigation-not-loaded (VP4)
  - Shared.csproj
...
| --- | --- | --- |
| /MediatR/ICommand.cs | `ICommand` + `ICommand<TResponse>` request markers | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-i-command.skill\|class-i-command]] |
| /MediatR/IQuery.cs | `IQuery<TResponse>` request marker | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-i-query.skill\|class-i-query]] |
| /MediatR/INotificationEvent.cs | `INotificationEvent` notification marker | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-i-notification-event.skill\|class-i-notification-event]] |
| /Logging/LogEvents.cs | `EventId` catalogue for searched-for log lines | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-log-events.skill\|class-log-events]] |
| /Exceptions/DomainException.cs | Single invariant-violation exception | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-domain-exception.skill\|class-domain-exception]] |
| /Repositories/*.cs | `IRepository<T>` / `IReadRepository<T>` | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-repository-contracts.skill\|class-repository-contracts]] |
| /UnitOfWork/IUnitOfWork.cs | The commit contract | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-i-unit-of-work.skill\|class-i-unit-of-work]] |
| /Concurrency/*.cs | `IVersioned` / `IHasVersions` / resolver contracts | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-concurrency-contracts.skill\|class-concurrency-contracts]] |
| /Timestamps/*.cs | Creation/update timestamp contracts | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-timestamp-contracts.skill\|class-timestamp-contracts]] |
| /Clients/I{Dependency}Client.cs | Outbound service contract returning `Result<T>` | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-i-dependency-client.skill\|class-i-dependency-client]] |
| /Guid/*.cs, /Results/ConflictResult.cs | Idempotent-create contracts + conflict result | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-guid-contracts.skill\|class-guid-contracts]] |
| /Exceptions/EntityNotLoadedException.cs | Required-navigation-not-loaded exception | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/Shared/classes/plateau-offline-sync-service--class-entity-not-loaded-exception.skill\|class-entity-not-loaded-exception]] |
...
- Pipeline behaviors — belong to [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/BuildingBlocks/plateau-offline-sync-service--csproj-building-blocks.skill|BuildingBlocks]].
- The logging provider configuration — belongs to [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/App.Host/classes/plateau-offline-sync-service--class-logging-registration.skill|LoggingRegistration.cs]].
