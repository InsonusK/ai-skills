---
name: plateau-offline-sync-service--class-i-dependency-client
description: Class I{Dependency}Client in the plateau-offline-sync-service plateau — the narrow Shared/Clients contract a handler injects to call an external service, one method per operation, each returning Result<T>
...
- [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/solution-grpc-client.skill|solution-grpc-client]] - [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/Implementation/Shared.csproj.extend/I{Dependency}Client.cs.create|I{Dependency}Client.cs]]
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-i-dependency-client
