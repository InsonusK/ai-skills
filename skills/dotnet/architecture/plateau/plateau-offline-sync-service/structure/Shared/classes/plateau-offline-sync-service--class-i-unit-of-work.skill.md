---
name: plateau-offline-sync-service--class-i-unit-of-work
description: Class IUnitOfWork in the plateau-offline-sync-service plateau — the single-method commit contract in Shared/UnitOfWork
...
- [[skills/dotnet/architecture/solutions/solution-unit-of-work.skill/solution-unit-of-work.skill|solution-unit-of-work]] - [[skills/dotnet/architecture/solutions/solution-unit-of-work.skill/Implementation/Shared.csproj.extend/IUnitOfWork.cs.create|IUnitOfWork.cs]]
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-i-unit-of-work
