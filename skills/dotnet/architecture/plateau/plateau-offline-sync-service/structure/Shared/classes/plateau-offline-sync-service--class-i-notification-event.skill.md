---
name: plateau-offline-sync-service--class-i-notification-event
description: Class INotificationEvent in the plateau-offline-sync-service plateau — the domain-fact notification marker in Shared/MediatR
...
- [[skills/dotnet/architecture/solutions/solution-mediator-integration.skill/solution-mediator-integration.skill|solution-mediator-integration]] - [[skills/dotnet/architecture/solutions/solution-mediator-integration.skill/Implementation/Shared.csproj.extend/INotificationEvent.cs.create|INotificationEvent.cs]]
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-i-notification-event
// Plateau: core
// Version: 20260902000000
using MediatR;
