---
name: plateau-offline-sync-service--class-domain-exception
description: Class DomainException in the plateau-offline-sync-service plateau — the single exception type for an entity invariant violation, carrying a stable machine code
...
- [[skills/dotnet/architecture/solutions/solution-domain-behaviour.skill/solution-domain-behaviour.skill|solution-domain-behaviour]] - [[skills/dotnet/architecture/solutions/solution-domain-behaviour.skill/Implementation/Shared.csproj.extend/DomainException.cs.create|DomainException.cs]]
...
# Implementation
```csharp
// Skill: plateau-offline-sync-service--class-domain-exception
