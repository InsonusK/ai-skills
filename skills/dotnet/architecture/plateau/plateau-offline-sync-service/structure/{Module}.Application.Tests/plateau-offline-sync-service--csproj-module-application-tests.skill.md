...
description: Project {Module}.Application.Tests in the plateau-offline-sync-service plateau — the dedicated test project for {Module}.Application, referencing the same projects {Module}.Application itself may reference
...
- /{Module}.Application.Tests
  - /Rules/{Rule}.feature
  - /StepDefinitions/[{Rule}Steps.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/{Module}.Application.Tests/classes/plateau-offline-sync-service--class-module-application-rule-steps.skill.md)
  - reqnroll.json
...
| /StepDefinitions/{Rule}Steps.cs | Bindings driving the real handler / validator | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/{Module}.Application.Tests/classes/plateau-offline-sync-service--class-module-application-rule-steps.skill\|class-module-application-rule-steps]] |
