...
## Project Structure
- /{ModuleName}.Domain
  - /Entities/[{Entity}.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/{Module}.Domain/classes/plateau-offline-sync-service--class-entity.skill.md)
  - /ValueObjects/[{ValueObject}.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/{Module}.Domain/classes/plateau-offline-sync-service--class-value-object.skill.md)
  - /Services/[{Behavior}Service.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/{Module}.Domain/classes/plateau-offline-sync-service--class-behavior-service.skill.md)
  - /Configurations/[{Entity}Config.cs](skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/{Module}.Domain/classes/plateau-offline-sync-service--class-entity-config.skill.md)
  - {ModuleName}.Domain.csproj

## Directory and class skills
| `Directory\|file` | Description | Pattern skill |
| --- | --- | --- |
| /Entities/{Entity}.cs | Entity with guarded state transitions | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/{Module}.Domain/classes/plateau-offline-sync-service--class-entity.skill\|class-entity]] |
| /ValueObjects/{ValueObject}.cs | Strict, self-validating value record | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/{Module}.Domain/classes/plateau-offline-sync-service--class-value-object.skill\|class-value-object]] |
| /Services/{Behavior}Service.cs | Static extension methods for bulky behavior | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/{Module}.Domain/classes/plateau-offline-sync-service--class-behavior-service.skill\|class-behavior-service]] |
| /Configurations/{Entity}Config.cs | EF Core persistence mapping for one entity | [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/{Module}.Domain/classes/plateau-offline-sync-service--class-entity-config.skill\|class-entity-config]] |
...
- Orchestration, handlers, validators — belong to [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/{Module}.Application/plateau-offline-sync-service--csproj-module-application.skill|{Module}.Application]].
- `DbContext`, repositories, `SaveChangesAsync` — belong to [[skills/dotnet/architecture/plateau/plateau-offline-sync-service/structure/App.Infrastructure/plateau-offline-sync-service--csproj-app-infrastructure.skill|App.Infrastructure]].
