---
name: plateau-domain-service--class-feature-handler
description: Class {FeatureName}Handler in the plateau-domain-service plateau — a command or query handler in {Module}.Application/Features, fixed shape, no persistence
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-feature-handler
// Plateau: core
// Version: 20260902000000
