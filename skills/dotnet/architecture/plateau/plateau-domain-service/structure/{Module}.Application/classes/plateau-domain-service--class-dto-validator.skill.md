---
name: plateau-domain-service--class-dto-validator
description: Class {Dto}Validator in the plateau-domain-service plateau — a reusable AbstractValidator<{Dto}> composing property validators plus the DTO's own local cross-field conditions
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-dto-validator
// Plateau: core
// Version: 20260902000000
