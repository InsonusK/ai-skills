---
name: plateau-domain-service--class-event-handler
description: Class {EventName}EventHandler in the plateau-domain-service plateau — a notification handler in {Module}.Application/Events, one per reacting concern
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-event-handler
// Plateau: core
// Version: 20260902000000
using MediatR;
