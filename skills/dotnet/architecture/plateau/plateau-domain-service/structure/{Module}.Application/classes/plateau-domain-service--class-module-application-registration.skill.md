---
name: plateau-domain-service--class-module-application-registration
description: Class {Module}ApplicationRegistration in the plateau-domain-service plateau — the module's one DI self-registration extension (AddMediatR + AddValidatorsFromAssembly)
...
- [[skills/dotnet/architecture/solutions/solution-mediator-integration.skill/solution-mediator-integration.skill|solution-mediator-integration]] - [[skills/dotnet/architecture/solutions/solution-mediator-integration.skill/Implementation/{Module}.Application.csproj.extend/{Module}ApplicationRegistration.cs.create|{Module}ApplicationRegistration.cs]]
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-module-application-registration
// Plateau: core
// Version: 20260902000000
