...
- /{Module}.Interfaces.Tests
  - /Rules/{Rule}.feature
  - /StepDefinitions/[{Rule}Steps.cs](skills/dotnet/architecture/plateau/plateau-domain-service/structure/{Module}.Interfaces.Tests/classes/plateau-domain-service--class-module-interfaces-rule-steps.skill.md)
  - reqnroll.json
...
| /StepDefinitions/{Rule}Steps.cs | Bindings constructing and inspecting the real contract types | [[skills/dotnet/architecture/plateau/plateau-domain-service/structure/{Module}.Interfaces.Tests/classes/plateau-domain-service--class-module-interfaces-rule-steps.skill\|class-module-interfaces-rule-steps]] |
