---
name: plateau-domain-service--class-grpc-status-extensions
description: Class GrpcStatusExtensions in the plateau-domain-service plateau — the single RpcException / StatusCode -> Ardalis.Result mapping used by every outbound gRPC adapter
...
- [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/solution-grpc-client.skill|solution-grpc-client]] - [[skills/dotnet/architecture/solutions/solution-grpc-client.skill/Implementation/App.Infrastructure.csproj.extend/GrpcStatusExtensions.cs.create|GrpcStatusExtensions.cs]]
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-grpc-status-extensions
// Plateau: domain-service
// Version: 20260902000000
