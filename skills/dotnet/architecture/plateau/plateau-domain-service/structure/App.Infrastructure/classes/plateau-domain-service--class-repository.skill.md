---
name: plateau-domain-service--class-repository
description: Class Repository<T> in the plateau-domain-service plateau — the one generic EF Core repository, inheriting Ardalis RepositoryBase<T>, implementing Shared IRepository<T>
...
- [[skills/dotnet/architecture/solutions/solution-repository-integration.skill/solution-repository-integration.skill|solution-repository-integration]] - [[skills/dotnet/architecture/solutions/solution-repository-integration.skill/Implementation/App.Infrastructure.csproj.extend/Repository.cs.create|Repository.cs]]
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-repository
// Plateau: domain-service
// Version: 20260902000000
