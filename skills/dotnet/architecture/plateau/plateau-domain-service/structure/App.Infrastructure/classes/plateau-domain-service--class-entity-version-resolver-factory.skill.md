---
name: plateau-domain-service--class-entity-version-resolver-factory
description: Class EntityVersionResolverFactory in the plateau-domain-service plateau — maps a stable entity name to its Application-layer IEntityVersionResolver by scanning Domain configs and Application resolvers
...
- [[skills/dotnet/architecture/solutions/solution-entity-concurrency-change.skill/solution-entity-concurrency-change.skill|solution-entity-concurrency-change]] - [[skills/dotnet/architecture/solutions/solution-entity-concurrency-change.skill/Implementation/App.Infrastructure.csproj.extend/EntityVersionResolverFactory.cs.create|EntityVersionResolverFactory.cs]]
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-entity-version-resolver-factory
// Plateau: domain-service
// Version: 20260902000000
