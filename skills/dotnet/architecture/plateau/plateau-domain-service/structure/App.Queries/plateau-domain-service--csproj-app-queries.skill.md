...
## Project Structure
- /App.Queries
  - /Specifications/[{Thing}ProjectionSpec.cs](skills/dotnet/architecture/plateau/plateau-domain-service/structure/App.Queries/classes/plateau-domain-service--class-cross-module-projection-spec.skill.md)
...
| --- | --- | --- |
| /Specifications/{Thing}ProjectionSpec.cs | Cross-module JOIN → read DTO | [[skills/dotnet/architecture/plateau/plateau-domain-service/structure/App.Queries/classes/plateau-domain-service--class-cross-module-projection-spec.skill\|class-cross-module-projection-spec]] |
