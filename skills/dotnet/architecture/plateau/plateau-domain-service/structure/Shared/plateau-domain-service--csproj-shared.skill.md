---
name: plateau-domain-service--csproj-shared
description: Project Shared in the plateau-domain-service plateau — cross-cutting contracts (the MediatR request markers, the LogEvents catalogue) that every layer may depend on
...
| /Repositories/*.cs | `IRepository<T>` / `IReadRepository<T>` | [[skills/dotnet/architecture/plateau/plateau-domain-service/structure/Shared/classes/plateau-domain-service--class-repository-contracts.skill\|class-repository-contracts]] |
| /UnitOfWork/IUnitOfWork.cs | The commit contract | [[skills/dotnet/architecture/plateau/plateau-domain-service/structure/Shared/classes/plateau-domain-service--class-i-unit-of-work.skill\|class-i-unit-of-work]] |
| /Concurrency/*.cs | `IVersioned` / `IHasVersions` / resolver contracts | [[skills/dotnet/architecture/plateau/plateau-domain-service/structure/Shared/classes/plateau-domain-service--class-concurrency-contracts.skill\|class-concurrency-contracts]] |
| /Timestamps/*.cs | Creation/update timestamp contracts | [[skills/dotnet/architecture/plateau/plateau-domain-service/structure/Shared/classes/plateau-domain-service--class-timestamp-contracts.skill\|class-timestamp-contracts]] |
| /Clients/I{Dependency}Client.cs | Outbound service contract returning `Result<T>` | [[skills/dotnet/architecture/plateau/plateau-domain-service/structure/Shared/classes/plateau-domain-service--class-i-dependency-client.skill\|class-i-dependency-client]] |
...
- Pipeline behaviors — belong to [[skills/dotnet/architecture/plateau/plateau-domain-service/structure/BuildingBlocks/plateau-domain-service--csproj-building-blocks.skill|BuildingBlocks]].
- The logging provider configuration — belongs to [[skills/dotnet/architecture/plateau/plateau-domain-service/structure/App.Host/classes/plateau-domain-service--class-logging-registration.skill|LoggingRegistration.cs]].
