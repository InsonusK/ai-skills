---
name: plateau-domain-service--class-i-query
description: Class IQuery<TResponse> in the plateau-domain-service plateau — the read-intent request marker in Shared/MediatR
...
- [[skills/dotnet/architecture/solutions/solution-mediator-integration.skill/solution-mediator-integration.skill|solution-mediator-integration]] - [[skills/dotnet/architecture/solutions/solution-mediator-integration.skill/Implementation/Shared.csproj.extend/IQuery.cs.create|IQuery.cs]]
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-i-query
// Plateau: core
// Version: 20260902000000
using MediatR;
