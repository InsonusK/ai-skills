---
name: plateau-domain-service--class-timestamp-contracts
description: Classes ICreationInfoModel(ReadOnly) / IUpdateInfoModel(ReadOnly) / ICommandWithTimestamp in the plateau-domain-service plateau — the Shared/Timestamps contracts for user vs server creation/update times
...
- [[skills/dotnet/architecture/solutions/solution-entity-edit-timestamp.skill/solution-entity-edit-timestamp.skill|solution-entity-edit-timestamp]] - [[skills/dotnet/architecture/solutions/solution-entity-edit-timestamp.skill/Implementation/Shared.csproj.extend/ICreationInfoModel.cs.create|ICreationInfoModel.cs]]
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-timestamp-contracts
// Plateau: domain-service
// Version: 20260902000000
