---
name: plateau-domain-service--class-i-notification-event
description: Class INotificationEvent in the plateau-domain-service plateau — the domain-fact notification marker in Shared/MediatR
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-i-notification-event
// Plateau: core
// Version: 20260902000000
using MediatR;
