---
name: plateau-domain-service--class-behavior-service
description: Class {Behavior}Service in the plateau-domain-service plateau — a static domain-service class of extension methods for bulky entity behavior in {Module}.Domain/Services
...
- [[skills/dotnet/architecture/solutions/solution-domain-behaviour.skill/solution-domain-behaviour.skill|solution-domain-behaviour]] - [[skills/dotnet/architecture/solutions/solution-domain-behaviour.skill/Implementation/{Module}.Domain.csproj.create/{Behavior}Service.cs.create|{Behavior}Service.cs]]
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-behavior-service
// Plateau: domain-service
// Version: 20260902000000
