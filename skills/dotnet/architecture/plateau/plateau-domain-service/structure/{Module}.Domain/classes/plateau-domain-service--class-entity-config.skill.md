---
name: plateau-domain-service--class-entity-config
description: Class {Entity}Config in the plateau-domain-service plateau — the EF Core IEntityTypeConfiguration that owns one entity's persistence mapping in {Module}.Domain/Configurations
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-entity-config
// Plateau: domain-service
// Version: 20260902000000
...
__Applied solutions:__
- [[skills/dotnet/architecture/solutions/solution-entity-concurrency-change.skill/solution-entity-concurrency-change.skill|solution-entity-concurrency-change]] - [[skills/dotnet/architecture/solutions/solution-entity-concurrency-change.skill/Implementation/{Module}.Domain.csproj.extend/{Entity}Config.cs.extend|{Entity}Config.cs]]
- [[skills/dotnet/architecture/solutions/solution-entity-edit-timestamp.skill/solution-entity-edit-timestamp.skill|solution-entity-edit-timestamp]] - [[skills/dotnet/architecture/solutions/solution-entity-edit-timestamp.skill/Implementation/{Module}.Domain.csproj.extend/{Entity}Config.cs.extend|{Entity}Config.cs]]
