---
name: plateau-domain-service--class-value-object
description: Class {ValueObject} in the plateau-domain-service plateau — a strict, self-validating value record in {Module}.Domain that inherits Soft{ValueObject} and throws on an invalid value
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-value-object
// Plateau: domain-service
// Version: 20260902000000
