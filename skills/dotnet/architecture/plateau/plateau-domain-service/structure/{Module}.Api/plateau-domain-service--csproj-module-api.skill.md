---
name: plateau-domain-service--csproj-module-api
description: Project {Module}.Api in the plateau-domain-service plateau — the module's thin inbound-API adapter (HTTP endpoints and/or gRPC services), mapping transport requests to Commands/Queries and dispatching via ISender
...
## Project Structure
- /{ModuleName}.Api
  - /Http/[{Entity}Endpoints.cs](skills/dotnet/architecture/plateau/plateau-domain-service/structure/{Module}.Api/classes/plateau-domain-service--class-endpoint.skill.md)
...
| --- | --- | --- |
| /Http/{Entity}Endpoints.cs | Minimal-API/controller endpoints dispatching via `ISender` | [[skills/dotnet/architecture/plateau/plateau-domain-service/structure/{Module}.Api/classes/plateau-domain-service--class-endpoint.skill\|class-endpoint]] |
...
__Applied solutions:__
- [[skills/dotnet/architecture/solutions/solution-http-api-publication.skill/solution-http-api-publication.skill|solution-http-api-publication]] - [[skills/dotnet/architecture/solutions/solution-http-api-publication.skill/solution-http-api-publication.skill|solution-http-api-publication]]
