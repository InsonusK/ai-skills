...
- /Shared.Tests
  - /Rules/{Rule}.feature
  - /StepDefinitions/[{Rule}Steps.cs](skills/dotnet/architecture/plateau/plateau-domain-service/structure/Shared.Tests/classes/plateau-domain-service--class-shared-rule-steps.skill.md)
  - reqnroll.json
  - Shared.Tests.csproj
...
| /StepDefinitions/{Rule}Steps.cs | Bindings asserting against the real `Shared` type | [[skills/dotnet/architecture/plateau/plateau-domain-service/structure/Shared.Tests/classes/plateau-domain-service--class-shared-rule-steps.skill\|class-shared-rule-steps]] |
