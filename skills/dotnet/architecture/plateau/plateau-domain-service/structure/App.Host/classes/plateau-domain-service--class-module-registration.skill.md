---
name: plateau-domain-service--class-module-registration
description: Class ModuleRegistration in the plateau-domain-service plateau — the one AddModules() extension where every module's Register{ModuleName}Module is called
...
- [[skills/dotnet/architecture/solutions/solution-sln-structure.skill/solution-sln-structure.skill|solution-sln-structure]] - [[skills/dotnet/architecture/solutions/solution-sln-structure.skill/Implementation/App.Host.csproj.create/ModuleRegistration.cs.create|ModuleRegistration.cs]]
...
# Implementation
```csharp
// Skill: plateau-domain-service--class-module-registration
// Plateau: core
// Version: 20260902000000
