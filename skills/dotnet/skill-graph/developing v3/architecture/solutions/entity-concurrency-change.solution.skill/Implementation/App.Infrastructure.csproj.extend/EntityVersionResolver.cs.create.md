...
- [ ] WHEN applied THEN Be the single place to update when new mutable entities are added to the solution
- [ ] WHEN applied THEN Static readonly dictionary — populated at startup, no runtime modification
- [ ] WHEN applied THEN Keys are stable business names agreed with the frontend — changing a key is a breaking API change
...
- [ ] WHEN verified THEN Every mutable entity registered in _map
- [ ] WHEN verified THEN Keys match business names used in IHasVersions and ETagEncoder
