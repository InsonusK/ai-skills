...
# Unittest TestCases
- [ ] WHEN applied THEN Register all MediatR pipeline behaviors in the single correct order
- [ ] WHEN applied THEN Be the authoritative record of what behaviors exist and in what sequence they run
...
- [ ] WHEN naming 'Pipeline registration' THEN pattern matches convention
