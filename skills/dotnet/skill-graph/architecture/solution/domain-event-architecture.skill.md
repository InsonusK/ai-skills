...
| ---------------------------------------- | -------------------------- | -------------------------------------- |
| `IDomainEvent` base interface            | `Shared`                   | [[skills/dotnet/skill-graph/Domain Layer/domain-event-pattern.skill]]         |
| Event definition (`record`)              | `{Module}.Domain/Events`   | [[skills/dotnet/skill-graph/Domain Layer/domain-event-pattern.skill]]         |
| Entity `_domainEvents` collection        | `{Module}.Domain/Entities` | [[skills/dotnet/skill-graph/Domain Layer/domain-event-pattern.skill]]         |
| `OutboxMessage` class                    | `BuildingBlocks`           | [[skills/dotnet/skill-graph/Infrastructure Layer/outbox-pattern.skill]]               |
| `DomainEventInterceptor`                 | `App.Infrastructure`       | [[skills/dotnet/skill-graph/Infrastructure Layer/outbox-pattern.skill]]               |
| `OutboxDispatcher` background service    | `App.Infrastructure`       | [[skills/dotnet/skill-graph/Infrastructure Layer/outbox-pattern.skill]]               |
| `INotificationHandler<T>` implementation | `{Module}.Application`     | [[skills/dotnet/skill-graph/Domain Layer/domain-event-handler-pattern.skill]] |
...
# Relations
- [[skills/dotnet/skill-graph/Domain Layer/domain-event-pattern.skill]] — how to define events and raise them on entities
- [[skills/dotnet/skill-graph/Infrastructure Layer/outbox-pattern.skill]] — OutboxMessage, interceptor, background dispatcher
- [[skills/dotnet/skill-graph/Domain Layer/domain-event-handler-pattern.skill]] — how to write handlers, idempotency rules
- [[backend-project-structure.skill]] — where each component lives in the solution
- [[cross-module-interaction.skill]] — integration events as cross-module communication