...
# Relations
- [[skills/dotnet/skill-graph/Domain Layer/command-handler-pattern.skill]] — handlers use IRepository and IUnitOfWork via this pattern
- [[query-handler-pattern.skill]] — query handlers use IReadRepository
- [[ardalis-specification-pattern.skill]] — all repository queries use specifications
- [[skills/dotnet/skill-graph/Domain Layer/domain-event-handler-pattern.skill]] — event handlers also use IRepository + IUnitOfWork
- [[backend-project-structure.skill]] — interfaces in BuildingBlocks, implementation in App.Infrastructure