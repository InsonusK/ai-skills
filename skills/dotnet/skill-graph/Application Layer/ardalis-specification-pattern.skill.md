...
# Relations
- [[repository-pattern.skill]] — IRepository and IReadRepository execute specifications
- [[skills/dotnet/skill-graph/Domain Layer/domain-event-handler-pattern.skill]] — idempotency specs used in event handlers
- [[skills/dotnet/skill-graph/Domain Layer/command-handler-pattern.skill]] — command handlers load entities via specs
- [[query-handler-pattern.skill]] — query handlers return results via projection specs
- [[entity-pattern.skill]] — specs filter entities defined in Domain