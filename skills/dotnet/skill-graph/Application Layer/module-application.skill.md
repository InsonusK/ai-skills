...
# Relations
- [[skills/dotnet/skill-graph/Domain Layer/command-handler-pattern.skill]] — structure and rules for command handlers
- [[query-handler-pattern.skill]] — structure and rules for query handlers
- [[skills/dotnet/skill-graph/Domain Layer/domain-event-handler-pattern.skill]] — event handlers in /EventHandlers
- [[ardalis-specification-pattern.skill]] — complex specs in /Specifications
- [[repository-pattern.skill]] — repository and UnitOfWork abstractions used here
- [[backend-project-structure.skill]] — Application layer in module structure