...
# Relations
- [[repository-pattern.skill]] — IReadRepository used in single-module handlers
- [[ardalis-specification-pattern.skill]] — specs used for filtering and projection
- [[skills/dotnet/skill-graph/Domain Layer/command-handler-pattern.skill]] — counterpart for write operations
- [[api-structure.skill]] — Result status mapped to HTTP responses in controller
- [[cross-module-interaction.skill]] — cross-module queries declared in Interfaces, implemented in App.Queries
- [[backend-project-structure.skill]] — placement rules for Application vs App.Queries