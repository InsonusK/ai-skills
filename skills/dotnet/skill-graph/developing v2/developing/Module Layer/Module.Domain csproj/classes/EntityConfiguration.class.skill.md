---
uid:
name: entity-configuration-class
description: EF Core entity type configuration class that owns all persistence concerns for one entity — indexes, relations, concurrency tokens, and value object mappings.
domain: skill
type: template
version: 20260610
tags:
...
| -------- | ------------------ | ---------- | ----------------- | --------- |
| Entity configuration | {EntityName}Config | TodoTaskConfig | {EntityName}Config.cs | TodoTaskConfig.cs |
