...
- Command in [[skills/dotnet/skill-graph/developing/Architecture/backend-project-structure.skill#Interfaces (.csproj)|{Module}.Interfaces]]
...
- Query implementation can be:
    - [[skills/dotnet/skill-graph/developing/Architecture/backend-project-structure.skill#Application (.csproj)|{Module Name}.Application]] (internal read model)
    - [[skills/dotnet/skill-graph/developing/Architecture/backend-project-structure.skill#App Infrastructure (.csproj)|App Infrastructure]] (cross-module joins allowed)
...
__Event Source__:
- [[skills/dotnet/skill-graph/developing/Architecture/backend-project-structure.skill#Application (.csproj)|{ModuleName}.Application]] - sending domain event
- [[skills/dotnet/skill-graph/developing/Architecture/backend-project-structure.skill#App Infrastructure (.csproj)|App.Infrastructure]] - sending app event
