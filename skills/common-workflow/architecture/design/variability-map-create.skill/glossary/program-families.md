...
- **Variability** — content that differs between at least two legitimate members of the family. Every [[skills/common-workflow/architecture/design/variability-map-create.skill/glossary/variation-point.md|Variation Point]] in a Variability Map exists because it was placed on this list.
...
- [[skills/common-workflow/architecture/design/variability-map-create.skill/glossary/feature-model.md|Feature Model]]
