...
- Fill `whenToUse` with the concrete class-level situations that require this skill (creating/editing this class, or creating another class with the same role). See [skill-design](skills/design/skill-design.skill/skill-design.skill.md) for the baseline rules.
