...
## Why it exists
An [[skills/common-workflow/architecture/design/variability-map-create.skill/glossary/orthogonal-variability-model.md|Orthogonal Variability Model]] table says *which* combinations of Variants are legal, but not *how to build the code* for a chosen combination. DOP answers that: start from one real, running [[skills/common-workflow/architecture/design/delta-conflict-detection.skill/glossary/core-module.md|Core module]], and apply every [[skills/common-workflow/architecture/design/delta-conflict-detection.skill/glossary/delta-module.md|Delta module]] whose [[skills/common-workflow/architecture/design/delta-conflict-detection.skill/glossary/application-condition.md|Application condition]] holds for the chosen Variants.
...
- Two deltas can land on the same artifact — see [[skills/common-workflow/architecture/design/delta-conflict-detection.skill/delta-conflict-detection.skill.md|delta-conflict-detection]] for how that is classified and, when needed, resolved.
...
## Related concepts
- [[skills/common-workflow/architecture/design/delta-conflict-detection.skill/glossary/core-module.md|Core module]]
- [[skills/common-workflow/architecture/design/delta-conflict-detection.skill/glossary/delta-module.md|Delta module]]
- [[skills/common-workflow/architecture/design/delta-conflict-detection.skill/glossary/application-condition.md|Application condition]]
