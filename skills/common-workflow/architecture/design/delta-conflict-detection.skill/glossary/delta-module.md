...
A **Delta module** is a self-contained set of add/remove/modify operations layered on top of a [[skills/common-workflow/architecture/design/delta-conflict-detection.skill/glossary/core-module.md|Core module]] (or on top of another delta already applied), active only when its [[skills/common-workflow/architecture/design/delta-conflict-detection.skill/glossary/application-condition.md|Application condition]] holds.
