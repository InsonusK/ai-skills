...
In this repository's [[skills/common-workflow/architecture/design/delta-conflict-detection.skill/delta-conflict-detection.skill.md|delta-conflict-detection]] workflow, this is exactly what gets built for a `TMC`, `FMC`, or `FDC` classification — never for a canonical code.
...
## Related concepts
- [[skills/common-workflow/architecture/design/delta-conflict-detection.skill/glossary/hard-soft-conflict.md|Hard conflict / soft conflict]]
