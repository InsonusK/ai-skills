...
A short walkthrough of applying [../variability-map-create.skill.md](skills/common-workflow/architecture/design/plateau-map/variability-map-create.skill/variability-map-create.skill.md) to a real catalog, `skills/dotnet/architecture/v3/`.
