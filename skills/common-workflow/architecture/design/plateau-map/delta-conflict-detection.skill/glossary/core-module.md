...
The **Core module** is the one concrete, fully-runnable, minimal baseline that every [[skills/common-workflow/architecture/design/plateau-map/delta-conflict-detection.skill/glossary/delta-module|Delta module]] is layered on top of, in [[skills/common-workflow/architecture/design/plateau-map/delta-conflict-detection.skill/glossary/delta-oriented-programming|Delta-Oriented Programming]].
