...
- Fill `whenToUse` first: one concrete sentence naming when a service/plateau needs this component attached. See the front matter comment above and [skill-design](skills/design/skill-design.skill/skill-design.skill.md) for the baseline rules.
