...
5. **Generate code.** Implement exactly the confirmed units, one responsibility per unit. Apply the stack's plateau/module skill if one exists for the unit's kind.
