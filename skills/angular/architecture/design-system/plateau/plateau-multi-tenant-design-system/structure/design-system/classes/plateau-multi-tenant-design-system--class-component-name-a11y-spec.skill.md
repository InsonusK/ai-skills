---
name: plateau-multi-tenant-design-system--class-component-name-a11y-spec
description: Generic @axe-core/playwright accessibility scan for a ds-* component at spec/{component}.a11y.spec.ts, targeting its projects/demo preview page — multi-tenant-design-system plateau
domain: skill
type: template
