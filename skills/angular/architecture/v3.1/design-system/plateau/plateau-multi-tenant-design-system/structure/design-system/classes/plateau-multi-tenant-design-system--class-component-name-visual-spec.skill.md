---
name: plateau-multi-tenant-design-system--class-component-name-visual-spec
description: Generic Playwright screenshot-regression spec for a ds-* component at spec/{component}.visual.spec.ts, targeting its projects/demo preview page in light and dark schemes — multi-tenant-design-system plateau
domain: skill
type: template
