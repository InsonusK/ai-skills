---
name: plateau-multi-tenant-design-system--class-component-name-component-spec
description: Generic behavioural spec for a ds-* component — Angular Testing Library through the rendered DOM, at spec/{component}.component.spec.ts, providing nothing beyond the component's own inputs — multi-tenant-design-system plateau
domain: skill
type: template
