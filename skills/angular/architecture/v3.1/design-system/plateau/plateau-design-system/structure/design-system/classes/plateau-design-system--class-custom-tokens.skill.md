...
description: Custom --ds-* tokens covering concepts Material's own M3 token set does not model — semantic status/priority colours, spacing, radius — each with light-dark() — design-system plateau
domain: skill
type: template
