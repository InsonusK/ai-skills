...
- No new tool or vendor: Playwright is already the adopted e2e framework (see [[skills/angular/architecture/v3.1/solutions/testing/solution-app-testing.skill/adr/e2e-framework-choice.md|e2e-framework-choice]]) — this is the same tool, a different assertion
