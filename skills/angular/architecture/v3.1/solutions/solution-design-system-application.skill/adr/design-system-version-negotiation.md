...
- Forces every embeddable-app team into lockstep with the platform's design-system version — an incompatible embeddable app simply fails to load, which directly conflicts with the independent-deploy guarantee `solution-platform-embeddability`'s Dynamic Federation was chosen to provide
