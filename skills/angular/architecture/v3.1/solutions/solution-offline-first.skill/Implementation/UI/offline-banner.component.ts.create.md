...
## MUST
- The banner MUST read `isOnline` from the shared `connectivity` slice — it MUST NOT read `navigator.onLine` directly, to stay consistent with the more accurate combined signal from [[skills/angular/architecture/v3.1/solutions/solution-offline-first.skill/adr/connectivity-detection.md|connectivity-detection]].
