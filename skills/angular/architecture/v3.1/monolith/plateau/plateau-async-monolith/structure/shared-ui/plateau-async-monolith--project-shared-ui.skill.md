---
name: plateau-async-monolith--project-shared-ui
description: App-specific reusable UI composed from design-system primitives — async-monolith plateau
domain: skill
type: template
...
> No solution produced a dedicated `shared-ui.project.create.md` file — this project is established implicitly by [[skills/angular/architecture/v3.1/monolith/plateau/plateau-async-monolith/structure/plateau-async-monolith--repo-async-monolith.skill.md|repo-async-monolith]]'s `Repository.create` directory table.
