---
name: plateau-persisted-state-monolith--class-feature-client-spec
description: Generic pattern for unit-testing a feature's Client via TestBed and HttpTestingController — the only place HttpTestingController is used — persisted-state-monolith plateau
domain: skill
type: template
