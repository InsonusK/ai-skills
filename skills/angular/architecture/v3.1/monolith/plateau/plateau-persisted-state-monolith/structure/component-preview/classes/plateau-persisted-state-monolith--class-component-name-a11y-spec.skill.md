---
name: plateau-persisted-state-monolith--class-component-name-a11y-spec
description: Generic pattern for an @axe-core/playwright accessibility scan under spec/, targeting a component's demo/preview page — persisted-state-monolith plateau
domain: skill
type: template
