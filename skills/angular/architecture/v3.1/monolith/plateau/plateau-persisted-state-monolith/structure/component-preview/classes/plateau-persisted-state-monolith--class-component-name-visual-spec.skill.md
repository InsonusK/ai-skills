---
name: plateau-persisted-state-monolith--class-component-name-visual-spec
description: Generic pattern for a Playwright screenshot-regression spec under spec/, targeting a component's demo/preview page in both light and dark color schemes — persisted-state-monolith plateau
domain: skill
type: template
