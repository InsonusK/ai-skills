...
| log-retry-queue.ts | Bounded IndexedDB retry queue. | [[skills/angular/architecture/v3.1/monolith/plateau/plateau-persisted-state-monolith/structure/shared-logging/classes/plateau-persisted-state-monolith--class-log-retry-queue.skill.md\|class-log-retry-queue]] |
| logger.service.ts | `report()` (always to the backend); `LOG_SINKS` factory adds `BackendLogSink`. | [[skills/angular/architecture/v3.1/monolith/plateau/plateau-persisted-state-monolith/structure/shared-logging/classes/plateau-persisted-state-monolith--class-logger-service.skill.md\|class-logger-service]] |
