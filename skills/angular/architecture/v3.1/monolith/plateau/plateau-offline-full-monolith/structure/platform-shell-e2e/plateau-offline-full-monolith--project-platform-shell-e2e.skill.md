...
| ------------------ | ----------- | -------------- |
| src/e2e/{scenario-name}.e2e.spec.ts | One spec per real user scenario | [[skills/angular/architecture/v3.1/monolith/plateau/plateau-offline-full-monolith/structure/platform-shell-e2e/classes/plateau-offline-full-monolith--class-scenario-name-e2e-spec.skill\|class-scenario-name-e2e-spec]] |
