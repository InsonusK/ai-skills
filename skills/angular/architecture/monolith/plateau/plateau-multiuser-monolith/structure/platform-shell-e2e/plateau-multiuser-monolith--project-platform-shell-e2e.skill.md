---
name: plateau-multiuser-monolith--project-platform-shell-e2e
description: Playwright end-to-end test project for the platform shell — scenario-level specs exercising real user flows against the built application — multiuser-monolith plateau
domain: skill
type: template
...
/apps/platform-shell-e2e
  /src
    /e2e
      [{scenario-name}.e2e.spec.ts](./classes/plateau-multiuser-monolith--class-scenario-name-e2e-spec.skill.md)
...
| ------------------ | ----------- | -------------- |
| src/e2e/{scenario-name}.e2e.spec.ts | One spec per real user scenario | [[skills/angular/architecture/monolith/plateau/plateau-multiuser-monolith/structure/platform-shell-e2e/classes/plateau-multiuser-monolith--class-scenario-name-e2e-spec.skill\|class-scenario-name-e2e-spec]] |
