---
name: plateau-multiuser-monolith--class-feature-mapper-and-errors
description: Generic pattern for a feature's hand-written DTO/domain mapper functions and its typed domain error hierarchy — multiuser-monolith plateau
domain: skill
type: template
