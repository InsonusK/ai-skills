---
name: plateau-offline-full-monolith--class-feature-facade-and-store-spec
description: Generic pattern for unit-testing a Facade (faking its Client) and a feature Signal Store (faking its Facade) via TestBed, without any HTTP mocking — offline-full-monolith plateau
domain: skill
type: template
