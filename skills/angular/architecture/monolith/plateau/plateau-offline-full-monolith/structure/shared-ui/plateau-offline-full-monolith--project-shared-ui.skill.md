...
| /pending-sync-indicator | The shared "N actions waiting to sync" indicator. Presentational (`count` input) — the owning feature feeds it from `MutationQueueService.pendingForFeature$`. | [[skills/angular/architecture/monolith/plateau/plateau-offline-full-monolith/structure/shared-ui/classes/plateau-offline-full-monolith--class-pending-sync-indicator-component.skill.md\|class-pending-sync-indicator-component]] |
