---
name: plateau-offline-full-monolith--class-replay-orchestrator
description: The replay orchestrator — connectivity-triggered, replays feature partitions concurrently (FIFO within a partition), with a single overridable server-wins handleConflict seam — plus MutationReplayRegistry and ReplayConflictError — offline-full-monolith plateau
domain: skill
type: template
