---
name: plateau-offline-full-monolith--project-shared-offline-sync
...
| ------------------ | ----------- | -------------- |
| mutation-queue.db.ts / mutation-queue.service.ts | Dexie schema + the queue's public API. `enqueue` generates the idempotency key; `pendingForFeature$` is a `liveQuery` observable for the indicator. | [[skills/angular/architecture/monolith/plateau/plateau-offline-full-monolith/structure/shared-offline-sync/classes/plateau-offline-full-monolith--class-mutation-queue-service.skill.md\|class-mutation-queue-service]] |
| replay-orchestrator.ts | `ReplayOrchestrator` (connectivity-triggered, concurrent partitions, `handleConflict` seam), `MutationReplayRegistry`, `ReplayConflictError`. | [[skills/angular/architecture/monolith/plateau/plateau-offline-full-monolith/structure/shared-offline-sync/classes/plateau-offline-full-monolith--class-replay-orchestrator.skill.md\|class-replay-orchestrator]] |
