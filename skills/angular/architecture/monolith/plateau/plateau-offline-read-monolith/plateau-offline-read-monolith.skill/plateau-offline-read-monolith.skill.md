...
parent_plateaus:
  - "[[skills/angular/architecture/monolith/plateau/plateau-async-monolith/plateau-async-monolith.skill/plateau-async-monolith.skill.md|plateau-async-monolith]]"
standalone: true
created_by:
...
New this plateau, per [`delta-conflict-analysis.md`](skills/angular/architecture/delta-conflict-analysis.md) — both canonical, no resolver:
