---
name: plateau-offline-read-monolith--class-feature-store
description: Generic pattern for a feature-level NgRx Signal Store — applies to any {Feature}/feature lib, unit-tested by faking its Facade — offline-read-monolith plateau
domain: skill
type: template
