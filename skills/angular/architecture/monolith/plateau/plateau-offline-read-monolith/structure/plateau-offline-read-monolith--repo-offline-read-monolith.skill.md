...
> **Third plateau in the monolith chain.** Composes [[skills/angular/architecture/monolith/plateau/plateau-async-monolith/structure/plateau-async-monolith--repo-async-monolith.skill.md|plateau-async-monolith]] (which already carries `plateau-online-monolith` + VP1) and adds exactly one solution — [[skills/angular/architecture/solutions/solution-offline-first.skill/solution-offline-first.skill.md|solution-offline-first]] (monolith **VP4 — OfflineReadResilience**). No new Nx project: a Workbox service worker is added to `apps/platform-shell`, a `connectivity` slice to `libs/shared/state`, a shared `OfflineTransportError` to `libs/shared/http-core`, an `OfflineBannerComponent` to `libs/shared/ui`, and the `status === 0` branch to every feature's Client. Scope is **read resilience only** — the shell always loads, API GETs fall back to last-known data; a mutation attempted offline still **fails immediately** (`OfflineTransportError`), for which this only prepares the hook. The durable write queue is [[skills/angular/architecture/monolith/plateau/plateau-offline-full-monolith/plateau-offline-full-monolith.skill/plateau-offline-full-monolith.skill.md|plateau-offline-full-monolith]] (VP5). No Module Federation, no backend log delivery, no authentication ([[skills/angular/architecture/monolith/plateau/plateau-multiuser-monolith/plateau-multiuser-monolith.skill/plateau-multiuser-monolith.skill.md|multiuser-monolith]] is last), every user still implicitly trusted. The [[skills/angular/architecture/design-system/plateau/plateau-design-system/plateau-design-system.skill/plateau-design-system.skill.md|design-system]] npm package remains a plain dependency of `apps/platform-shell`.
...
| ---------- | ------------- | ----------- |
| /apps/platform-shell | [[skills/angular/architecture/monolith/plateau/plateau-offline-read-monolith/structure/platform-shell/plateau-offline-read-monolith--project-platform-shell.skill\|project-platform-shell]] | The only deployable unit at this plateau. Composition root: bootstraps the app, owns top-level routing, registers root providers. |
| /apps/platform-shell-e2e | [[skills/angular/architecture/monolith/plateau/plateau-offline-read-monolith/structure/platform-shell-e2e/plateau-offline-read-monolith--project-platform-shell-e2e.skill\|project-platform-shell-e2e]] | Playwright end-to-end scenario specs against the real built application. |
...
| /libs/shared/ui | [[skills/angular/architecture/monolith/plateau/plateau-offline-read-monolith/structure/shared-ui/plateau-offline-read-monolith--project-shared-ui.skill\|project-shared-ui]] | Reusable, app-specific UI composed from design-system primitives. |
| /libs/shared/util | [[skills/angular/architecture/monolith/plateau/plateau-offline-read-monolith/structure/shared-util/plateau-offline-read-monolith--project-shared-util.skill\|project-shared-util]] | Framework-agnostic pure helpers shared across features. |
| /libs/shared/state | [[skills/angular/architecture/monolith/plateau/plateau-offline-read-monolith/structure/shared-state/plateau-offline-read-monolith--project-shared-state.skill\|project-shared-state]] | Classical NgRx Store. Now hosts the `connectivity` slice (`selectIsOnline`); `notifications`/`auth` arrive later in the chain. |
| /libs/shared/http-core | [[skills/angular/architecture/monolith/plateau/plateau-offline-read-monolith/structure/shared-http-core/plateau-offline-read-monolith--project-shared-http-core.skill\|project-shared-http-core]] | Base HTTP service + the shared `OfflineTransportError` every feature's Client throws on a network-level failure. |
| /libs/shared/logging | [[skills/angular/architecture/monolith/plateau/plateau-offline-read-monolith/structure/shared-logging/plateau-offline-read-monolith--project-shared-logging.skill\|project-shared-logging]] | `LoggerService` with a `ConsoleLogSink` — console-only at this plateau. |
| /libs/{feature}/feature | [[skills/angular/architecture/monolith/plateau/plateau-offline-read-monolith/structure/feature-feature/plateau-offline-read-monolith--project-feature-feature.skill\|project-feature-feature]] | Generic template: routed, presentational + container components (including forms and their component tests), feature-level Signal Store, own root-relative routes. |
| /libs/{feature}/data-access | [[skills/angular/architecture/monolith/plateau/plateau-offline-read-monolith/structure/feature-data-access/plateau-offline-read-monolith--project-feature-data-access.skill\|project-feature-data-access]] | Generic template: this feature's Facade/Client/Mapper/Errors layering, each with its own unit-test pattern. |
