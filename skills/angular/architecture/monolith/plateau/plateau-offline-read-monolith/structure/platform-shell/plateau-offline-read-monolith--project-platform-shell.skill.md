...
- [[skills/angular/architecture/v3.1/monolith/plateau/plateau-offline-read-monolith/structure/plateau-offline-read-monolith--repo-offline-read-monolith.skill#must never|repo-offline-read-monolith]]
