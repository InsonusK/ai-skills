---
name: plateau-async-monolith--class-read-visual-style-properties
description: Shared helper that reads a fixed, curated set of visually meaningful computed CSS properties from a page element, for use by every spec/{component-name}.style-snapshot.spec.ts — async-monolith plateau
domain: skill
type: template
