---
name: plateau-persisted-state-monolith--project-shared-ui
description: App-specific reusable UI composed from design-system primitives — plus the shell-mounted OfflineBannerComponent (VP4) — persisted-state-monolith plateau
domain: skill
type: template
...
| ------------------ | ----------- | -------------- |
| /offline-banner | The shared offline indicator. Presentational (`isOnline` input) — the shell owns the store wiring and mounts it once. | [[skills/angular/architecture/monolith/plateau/plateau-persisted-state-monolith/structure/shared-ui/classes/plateau-persisted-state-monolith--class-offline-banner-component.skill.md\|class-offline-banner-component]] |
| /pending-sync-indicator | The shared "N actions waiting to sync" indicator. Presentational (`count` input) — the owning feature feeds it from `MutationQueueService.pendingForFeature$`. | [[skills/angular/architecture/monolith/plateau/plateau-persisted-state-monolith/structure/shared-ui/classes/plateau-persisted-state-monolith--class-pending-sync-indicator-component.skill.md\|class-pending-sync-indicator-component]] |
