---
name: plateau-persisted-state-monolith--class-feature-integration-spec
description: Generic pattern for a feature-level integration test spanning Signal Store, Facade, and Client together, using MSW to intercept at the network boundary — persisted-state-monolith plateau
domain: skill
type: template
...
- [[skills/angular/architecture/solutions/solution-app-testing.skill/solution-app-testing.skill.md|solution-app-testing]] - [[skills/angular/architecture/solutions/solution-app-testing.skill/Implementation/Testing/{feature}.integration.spec.ts.create.md|{feature}.integration.spec.ts.create]]
