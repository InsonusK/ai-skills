...
## MUST
- Every test in this file MUST use `HttpTestingController` to assert the exact request (method, URL, body), per [[../../../../solution-testing.skill/adr/testing-layers-and-mocking.md]].
