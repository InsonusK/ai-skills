...
adr:
  - "[[adr/component-api-authoring-style.md]]"
  - "[[adr/component-encapsulation-strategy.md]]"
---
...
- [[adr/component-api-authoring-style.md|Signal-based input()/output()/model() exclusively, instead of decorators]]
...
- [[adr/component-encapsulation-strategy.md|Full API encapsulation with independently designed axes, internal implementation decided per component, instead of a thin passthrough wrapper or no wrapping at all]]
...
REPOSITORY:
- [[./Implementation/Repository.extend.md|Repository]] - extend - add the `ds-*` selector convention, signal-based API requirement, and the ControlValueAccessor/internal-implementation rules

Artifact-level:
- [[./Implementation/ComponentLayer/{component-name}.component.ts.create.md|{component-name} (generic pattern, with a worked ds-button example)]] - create - applied to every component added to the library
...
2. This is flagged against [[./Implementation/ComponentLayer/{component-name}.component.ts.create.md#Anti-patterns]] — mirroring Material's categorization this closely defeats the point of encapsulation, even without directly re-exporting Material's type.
...
- [[./Implementation/ComponentLayer/{component-name}.component.ts.create.md#MUST|ComponentLayer/{component-name}.component.ts.create]]

## SHOULD
- [[./Implementation/Repository.extend.md#SHOULD|Repository.extend]]
- [[./Implementation/ComponentLayer/{component-name}.component.ts.create.md#SHOULD|ComponentLayer/{component-name}.component.ts.create]]

# Anti-patterns

- [[./Implementation/Repository.extend.md|See Repository.extend.md]] — exposing a Material type/enum through the public API; defaulting to a custom implementation without first checking if Material suffices.
- [[./Implementation/ComponentLayer/{component-name}.component.ts.create.md|See {component-name}.component.ts.create.md]] — naming an input identically to Material's own corresponding input and enum.
