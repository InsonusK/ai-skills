...
depends_on:
  ...
  - "[[../solution-design-system-components.skill/solution-design-system-components.skill.md|Дизайн-система: компонентный слой]]"
  - "[[../solution-platform-embeddability.skill/solution-platform-embeddability.skill.md|Встраиваемость платформы]]"
adr:
  - "[[adr/design-system-version-negotiation.md]]"
  - "[[adr/theme-application-scope.md]]"
---
...
- [[adr/design-system-version-negotiation.md|Version-negotiated singleton instead of a strict singleton or fully independent per-consumer versions]]
...
- [[adr/theme-application-scope.md|Platform-shell applies the theme in production; embeddable apps apply it only for standalone development]]
...
## MUST
- [[./Implementation/PlatformHost/platform-shell.federation.extend.md#MUST|PlatformHost/platform-shell.federation.extend]]
- [[./Implementation/EmbeddableApp/federation.extend.md#MUST|EmbeddableApp/federation.extend]]

## SHOULD
- [[./Implementation/EmbeddableApp/federation.extend.md#SHOULD|EmbeddableApp/federation.extend]]

# Anti-patterns

- [[./Implementation/PlatformHost/platform-shell.federation.extend.md|See platform-shell.federation.extend.md]] — setting `strictVersion: true`, reintroducing lockstep coupling.
- [[./Implementation/EmbeddableApp/federation.extend.md|See federation.extend.md]] — declaring an unbounded `requiredVersion`; never updating it after initial setup.
