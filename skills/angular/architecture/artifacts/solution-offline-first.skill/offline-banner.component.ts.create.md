...
## MUST
- The banner MUST read `isOnline` from the shared `connectivity` slice — it MUST NOT read `navigator.onLine` directly, to stay consistent with the more accurate combined signal from [[../../adr/connectivity-detection.md]].
