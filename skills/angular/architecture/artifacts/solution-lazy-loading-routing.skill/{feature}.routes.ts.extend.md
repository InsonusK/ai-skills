...
## MUST
- A feature's own chunk MUST declare a per-chunk bundle budget (see [[../../../Repository.extend.md#MUST|Repository.extend]]); a sub-route split via `loadComponent` gets its own separate budget.
