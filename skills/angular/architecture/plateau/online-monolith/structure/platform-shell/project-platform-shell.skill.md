...
> `solution-testing` does not extend this project directly — its content lives in the sibling [[../platform-shell-e2e/project-platform-shell-e2e.skill.md|platform-shell-e2e]] project and in each feature's own test specs. Also depends on the `design-system` npm package (see the NPM Packages table below) — plain, non-federated consumption only.
...
## MUST
- [[../repo-online-monolith.skill.md#MUST|repo-online-monolith]]

## MUST NOT
- [[../repo-online-monolith.skill.md#MUST NOT|repo-online-monolith]]
