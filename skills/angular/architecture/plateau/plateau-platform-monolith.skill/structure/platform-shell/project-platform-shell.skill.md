...
> No global error handler yet — `GlobalErrorHandler` arrives with [[skills/angular/architecture/plateau/plateau-monitored-app.skill/plateau-monitored-app.skill|monitored-app]]. Also depends on the `design-system` npm package, unchanged from `online-monolith`.
...
| /remote-registry/remote-registry.service.ts | Runtime service resolving the list of available embeddable apps and their `remoteEntry` URLs from configuration | [[skills/angular/architecture/plateau/plateau-platform-monolith.skill/structure/platform-shell/classes/class-remote-registry-service.skill\|class-remote-registry-service]] |
...
| sw-build.ts / sw-src.ts | Workbox-generated service worker: app-shell precache, static-asset cache-first, API-read stale-while-revalidate, auth/mutation network-only, federated-remote stale-while-revalidate | [[skills/angular/architecture/plateau/plateau-platform-monolith.skill/structure/platform-shell/classes/class-service-worker.skill\|class-service-worker]] |
...
## MUST NOT
- [[skills/angular/architecture/plateau/plateau-platform-monolith.skill/structure/repo-platform-monolith.skill#MUST NOT|repo-platform-monolith]]
