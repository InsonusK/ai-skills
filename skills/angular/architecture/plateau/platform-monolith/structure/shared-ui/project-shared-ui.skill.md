...
- Host reusable, app-specific UI composed out of [[skills/angular/architecture/plateau/design-system/plateau-design-system.skill.md|design-system]] primitives, including offline read and write feedback
...
| pending-sync-indicator.component.ts | Reactively shows how many actions are queued and waiting to sync for a given feature | [[classes/class-pending-sync-indicator-component.skill.md\|class-pending-sync-indicator-component.skill]] |
