...
description: Workbox-generated service worker for apps/platform-shell — content-type-specific runtime caching strategies for read resilience, now including stale-while-revalidate for federated remote chunks
domain: skill
type: template
