...
| ------------------ | ----------- | -------------- |
| has-permission.directive.ts | Structural directive `*hasPermission` that shows/hides UI based on the current user's permissions | [[skills/angular/architecture/plateau/plateau-multiuser-app.skill/structure/shared-auth-ui/classes/class-has-permission-directive.skill\|class-has-permission-directive]] |
| permission.guard.ts | `requirePermission(...)` functional route-guard factory | [[skills/angular/architecture/plateau/plateau-multiuser-app.skill/structure/shared-auth-ui/classes/class-permission-guard.skill\|class-permission-guard]] |
