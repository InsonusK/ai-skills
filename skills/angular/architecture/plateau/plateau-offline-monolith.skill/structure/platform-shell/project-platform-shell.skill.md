...
description: The single deployable Angular application — composition root, routing, now with a selective preloading strategy and a registered service worker. No global error handler yet.
domain: skill
type: template
...
## MUST NOT
- [[skills/angular/architecture/plateau/plateau-offline-monolith.skill/structure/repo-offline-monolith.skill#MUST NOT|repo-offline-monolith]]
