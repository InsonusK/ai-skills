---
name: plateau-async-monolith--class-connectivity-store
description: Connectivity slice inside libs/shared/state — combines navigator.onLine events with a periodic health-check for an accurate isOnline signal — async-monolith plateau
domain: skill
type: template
