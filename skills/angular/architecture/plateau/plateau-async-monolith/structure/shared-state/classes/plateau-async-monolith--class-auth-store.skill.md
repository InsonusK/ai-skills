---
name: plateau-async-monolith--class-auth-store
description: Auth session slice inside libs/shared/state — classical NgRx actions/reducer/effects/selectors — async-monolith plateau
domain: skill
type: template
