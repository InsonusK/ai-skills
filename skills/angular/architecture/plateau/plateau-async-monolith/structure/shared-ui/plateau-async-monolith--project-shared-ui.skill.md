...
description: App-specific reusable UI composed from design-system primitives, now including the offline banner — async-monolith plateau
domain: skill
type: template
...
/libs/shared/ui
  /src
    /lib
      [offline-banner.component.ts](./classes/plateau-async-monolith--class-offline-banner-component.skill.md)
    index.ts
```
