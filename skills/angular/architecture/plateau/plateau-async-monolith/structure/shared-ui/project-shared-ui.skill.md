...
| ------------------ | ----------- | -------------- |
| offline-banner.component.ts | Persistent banner informing the user the app is offline | [[skills/angular/architecture/plateau/plateau-async-monolith/structure/shared-ui/classes/class-offline-banner-component.skill\|class-offline-banner-component]] |
