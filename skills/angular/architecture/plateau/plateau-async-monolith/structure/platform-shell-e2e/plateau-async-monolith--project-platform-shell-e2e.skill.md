...
| ------------------ | ----------- | -------------- |
| src/e2e/{scenario-name}.e2e.spec.ts | One spec per real user scenario | [[skills/angular/architecture/plateau/plateau-async-monolith/structure/platform-shell-e2e/classes/plateau-async-monolith--class-scenario-name-e2e-spec.skill\|class-scenario-name-e2e-spec]] |
