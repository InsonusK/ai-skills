---
name: plateau-async-monolith--class-scenario-name-e2e-spec
description: Generic pattern for a Playwright end-to-end test in apps/platform-shell-e2e, exercising a real user scenario through a real browser — async-monolith plateau
domain: skill
type: template
