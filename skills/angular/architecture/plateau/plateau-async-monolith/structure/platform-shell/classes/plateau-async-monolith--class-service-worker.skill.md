---
name: plateau-async-monolith--class-service-worker
description: Workbox-generated service worker for apps/platform-shell — content-type-specific runtime caching strategies for read resilience — async-monolith plateau
domain: skill
type: template
