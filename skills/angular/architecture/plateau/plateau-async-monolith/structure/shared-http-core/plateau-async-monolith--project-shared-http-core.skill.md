...
description: Base HTTP service shared by every feature's Client — common concerns (base URL, timeout, retry) and the shared OfflineTransportError type — async-monolith plateau
domain: skill
type: template
