...
> No solution produced a dedicated `shared-ui.project.create.md` file — this project is established implicitly by [[../repo-data-capable.skill.md|repo-data-capable]]'s `Repository.create` directory table. Unchanged since [[skills/angular/architecture/plateau/foundation/plateau-foundation.skill.md|foundation]].
...
## MUST
- [[../repo-data-capable.skill.md#MUST|repo-data-capable]]
