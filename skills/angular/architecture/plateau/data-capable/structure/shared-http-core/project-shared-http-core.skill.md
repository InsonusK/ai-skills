...
- Auth token attachment — handled globally by an auth interceptor, registered independently of this service (see the future [[skills/angular/architecture/plateau/authenticated/plateau-authenticated.skill.md|authenticated]] plateau)
