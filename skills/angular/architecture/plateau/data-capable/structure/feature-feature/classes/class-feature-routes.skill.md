...
> Unchanged since [[skills/angular/architecture/plateau/navigable/plateau-navigable.skill.md|navigable]] — neither `solution-forms` nor `solution-api-http-layer` touch a feature's routes.
