...
description: Playwright end-to-end test project for the platform shell — scenario-level specs exercising real user flows against the built application, including federated remote loading
domain: skill
type: template
plateau: platform
...
- Provide a dedicated project for cross-cutting, browser-based end-to-end tests of the platform shell and its integrated features, including scenarios that cross into a mounted embeddable app
...
- The suite stays focused on a small number of critical, cross-cutting user journeys
...
| ------------------ | ----------- | -------------- |
| src/e2e/{scenario-name}.e2e.spec.ts | One spec per real user scenario | [[classes/class-scenario-name-e2e-spec.skill.md\|class-scenario-name-e2e-spec.skill]] |
...
- None — drives the built application through the browser only
