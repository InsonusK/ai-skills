---
name: plateau-offline-monolith--class-offline-banner-component
description: Shared offline banner component, reading the connectivity slice to inform the user when the application is offline — offline-monolith plateau
domain: skill
type: template
