---
name: plateau-offline-monolith--class-auth-store
description: Auth session slice inside libs/shared/state — classical NgRx actions/reducer/effects/selectors — offline-monolith plateau
domain: skill
type: template
