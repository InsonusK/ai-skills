---
name: plateau-offline-monolith--class-feature-store
description: Generic pattern for a feature-level NgRx Signal Store — applies to any {Feature}/feature lib — offline-monolith plateau
domain: skill
type: template
