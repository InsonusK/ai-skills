---
name: plateau-offline-monolith--project-platform-shell
description: The single deployable Angular application — composition root, routing, now with a selective preloading strategy and a registered service worker. No global error handler yet. — offline-monolith plateau
domain: skill
type: template
...
> No global error handler yet — `GlobalErrorHandler` arrives with [[skills/angular/architecture/plateau/plateau-monitored-app/plateau-monitored-app.skill.md|monitored-app]]. Also depends on the `design-system` npm package, unchanged from `online-monolith`.
...
- [[skills/angular/architecture/solutions/solution-lazy-loading-routing.skill/solution-lazy-loading-routing.skill.md|solution-lazy-loading-routing]] - [[skills/angular/architecture/solutions/solution-lazy-loading-routing.skill/Implementation/PlatformHost/platform-shell.project.extend|PlatformHost/platform-shell.project.extend]]
...
__Applied solutions:__
- [[skills/angular/architecture/solutions/solution-lazy-loading-routing.skill/solution-lazy-loading-routing.skill.md|solution-lazy-loading-routing]] - [[skills/angular/architecture/solutions/solution-lazy-loading-routing.skill/Implementation/PlatformHost/platform-shell.project.extend|PlatformHost/platform-shell.project.extend]]
- [[skills/angular/architecture/solutions/solution-offline-first.skill/solution-offline-first.skill.md|solution-offline-first]] - [[skills/angular/architecture/solutions/solution-offline-first.skill/Implementation/PlatformHost/platform-shell.project.extend|PlatformHost/platform-shell.project.extend]]
...
/apps/platform-shell
  /src
    ...
    sw-build.ts                       <- see [plateau-offline-monolith--class-service-worker.skill.md](./classes/plateau-offline-monolith--class-service-worker.skill.md)
    sw-src.ts                         <- see [plateau-offline-monolith--class-service-worker.skill.md](./classes/plateau-offline-monolith--class-service-worker.skill.md)
    main.ts
```
...
| sw-build.ts / sw-src.ts | Workbox-generated service worker: app-shell precache, static-asset cache-first, API-read stale-while-revalidate, auth/mutation network-only | [[skills/angular/architecture/plateau/plateau-offline-monolith/structure/platform-shell/classes/plateau-offline-monolith--class-service-worker.skill\|class-service-worker]] |
...
## MUST NOT
- [[skills/angular/architecture/plateau/plateau-offline-monolith/structure/plateau-offline-monolith--repo-offline-monolith.skill#MUST NOT|repo-offline-monolith]]
