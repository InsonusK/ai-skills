---
name: plateau-offline-monolith--class-feature-facade
description: Generic pattern for a feature's Facade — the public entry point of its data-access lib, owning business validation, orchestration, and the offline-queueing decision — offline-monolith plateau
domain: skill
type: template
