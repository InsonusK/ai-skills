---
name: plateau-offline-monolith--class-mutation-queue-service
description: Dexie database definition and public MutationQueueService API — schema, per-feature partitioning, reactive queries for pending-sync UI — offline-monolith plateau
domain: skill
type: template
