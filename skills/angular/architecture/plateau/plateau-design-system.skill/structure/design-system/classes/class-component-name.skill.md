---
name: class-component-name
description: Generic pattern for authoring any design system component — own ds-* selector, signal-based API, independently designed axes, per-component internal implementation decision
domain: skill
type: template
