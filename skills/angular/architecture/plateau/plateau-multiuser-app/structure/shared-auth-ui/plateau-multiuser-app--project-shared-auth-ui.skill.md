---
name: plateau-multiuser-app--project-shared-auth-ui
description: Shared library for authentication-related UI primitives — permission-checking directive and route-guard factory — multiuser-app plateau
domain: skill
type: template
...
/libs/shared/auth-ui
  /src
    /lib
      [has-permission.directive.ts](./classes/plateau-multiuser-app--class-has-permission-directive.skill.md)
      [permission.guard.ts](./classes/plateau-multiuser-app--class-permission-guard.skill.md)
    index.ts
```
...
| ------------------ | ----------- | -------------- |
| has-permission.directive.ts | Structural directive `*hasPermission` that shows/hides UI based on the current user's permissions | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/shared-auth-ui/classes/plateau-multiuser-app--class-has-permission-directive.skill\|class-has-permission-directive]] |
| permission.guard.ts | `requirePermission(...)` functional route-guard factory | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/shared-auth-ui/classes/plateau-multiuser-app--class-permission-guard.skill\|class-permission-guard]] |
...
## MUST
- The library MUST NOT depend on feature libraries.
- Any code here that checks "is the user allowed to do X" MUST express the check as a permission string.
