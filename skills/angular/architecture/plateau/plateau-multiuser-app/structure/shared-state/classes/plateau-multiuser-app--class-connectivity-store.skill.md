---
name: plateau-multiuser-app--class-connectivity-store
description: Connectivity slice inside libs/shared/state — combines navigator.onLine events with a periodic health-check for an accurate isOnline signal — multiuser-app plateau
domain: skill
type: template
