---
name: plateau-multiuser-app--class-auth-interceptor
description: HTTP interceptor that attaches the in-memory access token to outgoing requests and triggers a silent refresh on 401 responses — multiuser-app plateau
domain: skill
type: template
