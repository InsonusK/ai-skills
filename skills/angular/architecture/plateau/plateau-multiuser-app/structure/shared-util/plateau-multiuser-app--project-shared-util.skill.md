---
name: plateau-multiuser-app--project-shared-util
description: Framework-agnostic pure helpers shared across features — multiuser-app plateau
domain: skill
type: template
...
> No solution produced a dedicated `shared-util.project.create.md` file — this project is established implicitly by [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/plateau-multiuser-app--repo-multiuser-app.skill.md|repo-multiuser-app]]'s `Repository.create` entry. Unchanged by every solution applied since.
