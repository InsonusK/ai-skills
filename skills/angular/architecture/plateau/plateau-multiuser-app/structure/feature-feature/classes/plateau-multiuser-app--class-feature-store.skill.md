---
name: plateau-multiuser-app--class-feature-store
description: Generic pattern for a feature-level NgRx Signal Store — applies to any {Feature}/feature lib — multiuser-app plateau
domain: skill
type: template
