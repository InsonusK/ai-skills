---
name: plateau-multiuser-app--class-scenario-name-e2e-spec
description: Generic pattern for a Playwright end-to-end test in apps/platform-shell-e2e, exercising a real user scenario through a real browser — multiuser-app plateau
domain: skill
type: template
