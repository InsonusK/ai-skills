---
name: plateau-multiuser-app--class-backend-log-sink
description: BackendLogSink — batches warn/error/report entries and sends them to the backend, with a beacon-based flush on unload and retry-queue fallback on failure — multiuser-app plateau
domain: skill
type: template
