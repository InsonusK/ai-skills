---
name: plateau-multiuser-app--class-feature-facade
description: Generic pattern for a feature's Facade — the public entry point of its data-access lib, owning business validation, orchestration, and the offline-queueing decision — multiuser-app plateau
domain: skill
type: template
