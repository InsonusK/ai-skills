---
name: plateau-multiuser-app--class-feature-client
description: Generic pattern for a feature's Client — the internal transport layer of its data-access lib, mapping DTOs and translating every transport failure (including offline) into a typed domain error — multiuser-app plateau
domain: skill
type: template
