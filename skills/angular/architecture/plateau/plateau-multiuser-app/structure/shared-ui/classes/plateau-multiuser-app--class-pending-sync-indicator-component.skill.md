---
name: plateau-multiuser-app--class-pending-sync-indicator-component
description: Shared pending-sync indicator, reactively reading MutationQueueService's live query to show how many actions are queued for a feature — multiuser-app plateau
domain: skill
type: template
