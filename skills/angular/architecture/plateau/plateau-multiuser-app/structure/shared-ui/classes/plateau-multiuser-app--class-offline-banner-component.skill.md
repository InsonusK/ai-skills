---
name: plateau-multiuser-app--class-offline-banner-component
description: Shared offline banner component, reading the connectivity slice to inform the user when the application is offline — multiuser-app plateau
domain: skill
type: template
