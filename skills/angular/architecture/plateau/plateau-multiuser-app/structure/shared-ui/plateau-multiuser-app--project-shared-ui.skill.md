---
name: plateau-multiuser-app--project-shared-ui
description: App-specific reusable UI composed from design-system primitives — the offline banner plus a per-feature pending-sync indicator — multiuser-app plateau
domain: skill
type: template
...
/libs/shared/ui
  /src
    /lib
      [offline-banner.component.ts](./classes/plateau-multiuser-app--class-offline-banner-component.skill.md)
      [pending-sync-indicator.component.ts](./classes/plateau-multiuser-app--class-pending-sync-indicator-component.skill.md)
    index.ts
```
...
| ------------------ | ----------- | -------------- |
| offline-banner.component.ts | Persistent banner informing the user the app is offline | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/shared-ui/classes/plateau-multiuser-app--class-offline-banner-component.skill\|class-offline-banner-component]] |
| pending-sync-indicator.component.ts | Reactively shows how many actions are queued and waiting to sync for a given feature | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/shared-ui/classes/plateau-multiuser-app--class-pending-sync-indicator-component.skill\|class-pending-sync-indicator-component]] |
