---
name: plateau-multiuser-app--class-replay-orchestrator
description: Replay orchestrator — triggered by connectivity restoration, replays each feature's queue partition independently, and implements the server-wins conflict-handling seam — multiuser-app plateau
domain: skill
type: template
