---
name: plateau-multiuser-app--project-shared-http-core
description: Base HTTP service shared by every feature's Client — common concerns (base URL, timeout, retry) and the shared OfflineTransportError type — multiuser-app plateau
domain: skill
type: template
