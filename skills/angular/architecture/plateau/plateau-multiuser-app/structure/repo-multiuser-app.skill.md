...
| ---------- | ------------- | ----------- |
| /apps/platform-shell | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/platform-shell/project-platform-shell.skill\|project-platform-shell]] | Composition root — unchanged in structure; now serves `SessionContract` to every mounted embeddable app. |
| /apps/platform-shell-e2e | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/platform-shell-e2e/project-platform-shell-e2e.skill\|project-platform-shell-e2e]] | Playwright end-to-end scenario specs, now including login/logout and a permission-denied scenario. |
| /libs/shared/ui | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/shared-ui/project-shared-ui.skill\|project-shared-ui]] | Reusable, app-specific UI — unchanged. |
| /libs/shared/util | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/shared-util/project-shared-util.skill\|project-shared-util]] | Framework-agnostic pure helpers shared across features. |
| /libs/shared/state | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/shared-state/project-shared-state.skill\|project-shared-state]] | Classical NgRx Store; `auth` slice is now a real session lifecycle (login, silent refresh, logout), plus `authInterceptor`. |
| /libs/shared/http-core | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/shared-http-core/project-shared-http-core.skill\|project-shared-http-core]] | Base HTTP service and `OfflineTransportError` — unchanged. |
| /libs/shared/auth-ui | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/shared-auth-ui/project-shared-auth-ui.skill\|project-shared-auth-ui]] | Permission-checking directive (`*hasPermission`) and route-guard factory (`requirePermission`) shared by every feature. |
| /libs/shared/logging | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/shared-logging/project-shared-logging.skill\|project-shared-logging]] | `LoggerService`, `BackendLogSink`, `LogRetryQueue` — unchanged. |
| /libs/shared/offline-sync | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/shared-offline-sync/project-shared-offline-sync.skill\|project-shared-offline-sync]] | Mutation queue and replay orchestrator — unchanged. |
| /libs/{feature}/feature | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/feature-feature/project-feature-feature.skill\|project-feature-feature]] | Generic template, now optionally attaching a `requirePermission` guard to its own routes. |
| /libs/{feature}/data-access | [[skills/angular/architecture/plateau/plateau-multiuser-app/structure/feature-data-access/project-feature-data-access.skill\|project-feature-data-access]] | Generic template — unchanged. |
