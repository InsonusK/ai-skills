---
name: plateau-multiuser-app--class-service-worker
description: Workbox-generated service worker for apps/platform-shell — content-type-specific runtime caching strategies for read resilience, now including stale-while-revalidate for federated remote chunks — multiuser-app plateau
domain: skill
type: template
