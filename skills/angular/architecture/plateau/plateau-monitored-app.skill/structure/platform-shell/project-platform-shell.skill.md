...
| app/global-error-handler.ts | Global `ErrorHandler` routing every uncaught exception through `LoggerService.error` | [[skills/angular/architecture/plateau/plateau-monitored-app.skill/structure/platform-shell/classes/class-global-error-handler.skill\|class-global-error-handler]] |
| /remote-registry/remote-registry.service.ts | Runtime service resolving the list of available embeddable apps and their `remoteEntry` URLs from configuration | [[skills/angular/architecture/plateau/plateau-monitored-app.skill/structure/platform-shell/classes/class-remote-registry-service.skill\|class-remote-registry-service]] |
...
| sw-build.ts / sw-src.ts | Workbox-generated service worker: app-shell precache, static-asset cache-first, API-read stale-while-revalidate, auth/mutation network-only, federated-remote stale-while-revalidate | [[skills/angular/architecture/plateau/plateau-monitored-app.skill/structure/platform-shell/classes/class-service-worker.skill\|class-service-worker]] |
...
## MUST NOT
- [[skills/angular/architecture/plateau/plateau-monitored-app.skill/structure/repo-monitored-app.skill#MUST NOT|repo-monitored-app]]
