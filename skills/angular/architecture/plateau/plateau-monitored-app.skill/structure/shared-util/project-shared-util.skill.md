...
> No solution produced a dedicated `shared-util.project.create.md` file — this project is established implicitly by [[skills/angular/architecture/plateau/plateau-monitored-app.skill/structure/repo-monitored-app.skill|repo-monitored-app]]'s `Repository.create` entry. Unchanged by every solution applied since.
