---
name: plateau-monitored-app--class-mutation-queue-service
description: Dexie database definition and public MutationQueueService API — schema, per-feature partitioning, reactive queries for pending-sync UI — monitored-app plateau
domain: skill
type: template
