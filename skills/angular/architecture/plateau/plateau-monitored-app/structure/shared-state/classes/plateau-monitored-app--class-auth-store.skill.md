---
name: plateau-monitored-app--class-auth-store
description: Auth session slice inside libs/shared/state — classical NgRx actions/reducer/effects/selectors — monitored-app plateau
domain: skill
type: template
