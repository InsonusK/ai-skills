---
name: plateau-monitored-app--class-feature-store
description: Generic pattern for a feature-level NgRx Signal Store — applies to any {Feature}/feature lib — monitored-app plateau
domain: skill
type: template
