---
name: plateau-monitored-app--class-remote-registry-service
description: Runtime service that resolves embeddable apps' remoteEntry URLs from a configuration manifest instead of build-time federation config — monitored-app plateau
domain: skill
type: template
