---
name: plateau-monitored-app--class-global-error-handler
description: Global ErrorHandler catching every uncaught exception and routing it through LoggerService.error — monitored-app plateau
domain: skill
type: template
