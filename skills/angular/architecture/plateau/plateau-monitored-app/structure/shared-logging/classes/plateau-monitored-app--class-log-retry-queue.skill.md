---
name: plateau-monitored-app--class-log-retry-queue
description: Bounded, IndexedDB-persisted retry queue for log batches that failed to send, evicting the oldest entries when any of three limits (count, age, size) is exceeded — monitored-app plateau
domain: skill
type: template
