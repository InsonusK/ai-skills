---
name: plateau-monitored-app--class-feature-mapper-and-errors
description: Generic pattern for a feature's hand-written DTO/domain mapper functions and its typed domain error hierarchy — monitored-app plateau
domain: skill
type: template
