...
| ------------------ | ----------- | -------------- |
| src/e2e/{scenario-name}.e2e.spec.ts | One spec per real user scenario | [[skills/angular/architecture/plateau/plateau-monitored-app/structure/platform-shell-e2e/classes/class-scenario-name-e2e-spec.skill\|class-scenario-name-e2e-spec]] |
