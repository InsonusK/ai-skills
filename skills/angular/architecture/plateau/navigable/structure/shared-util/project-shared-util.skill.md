...
> No solution produced a dedicated `shared-util.project.create.md` file — this project is established implicitly by [[../repo-navigable.skill.md|repo-navigable]]'s `Repository.create` directory table. Unchanged since [[skills/angular/architecture/plateau/foundation/plateau-foundation.skill.md|foundation]].
