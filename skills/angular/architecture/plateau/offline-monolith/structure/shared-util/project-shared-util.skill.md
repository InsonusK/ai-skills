...
> No solution produced a dedicated `shared-util.project.create.md` file — this project is established implicitly by [[../repo-offline-monolith.skill.md|repo-offline-monolith]]'s `Repository.create` entry. Unchanged by every solution applied since.
