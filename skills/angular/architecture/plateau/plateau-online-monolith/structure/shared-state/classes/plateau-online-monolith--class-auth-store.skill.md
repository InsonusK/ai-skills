---
name: plateau-online-monolith--class-auth-store
description: Auth session slice inside libs/shared/state — classical NgRx actions/reducer/effects/selectors — online-monolith plateau
domain: skill
type: template
