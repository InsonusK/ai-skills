---
name: plateau-platform-monolith--class-offline-banner-component
description: Shared offline banner component, reading the connectivity slice to inform the user when the application is offline — platform-monolith plateau
domain: skill
type: template
