---
name: plateau-platform-monolith--class-pending-sync-indicator-component
description: Shared pending-sync indicator, reactively reading MutationQueueService's live query to show how many actions are queued for a feature — platform-monolith plateau
domain: skill
type: template
