---
name: plateau-platform-monolith--class-replay-orchestrator
description: Replay orchestrator — triggered by connectivity restoration, replays each feature's queue partition independently, and implements the server-wins conflict-handling seam — platform-monolith plateau
domain: skill
type: template
