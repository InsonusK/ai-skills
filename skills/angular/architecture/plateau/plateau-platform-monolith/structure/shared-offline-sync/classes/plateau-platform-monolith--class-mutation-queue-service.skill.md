---
name: plateau-platform-monolith--class-mutation-queue-service
description: Dexie database definition and public MutationQueueService API — schema, per-feature partitioning, reactive queries for pending-sync UI — platform-monolith plateau
domain: skill
type: template
