...
- [[skills/angular/architecture/solutions/solution-testing.skill/solution-testing.skill.md|solution-testing]] - [[skills/angular/architecture/solutions/solution-testing.skill/Implementation/Testing/{scenario-name}.e2e.spec.ts.create|Testing/{scenario-name}.e2e.spec.ts.create]]
