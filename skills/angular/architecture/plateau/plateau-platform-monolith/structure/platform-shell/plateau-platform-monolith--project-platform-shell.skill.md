---
name: plateau-platform-monolith--project-platform-shell
description: The single deployable Angular application — composition root, routing, selective preloading, registered service worker, and now a Native Federation dynamic host loading embeddable apps at runtime. No global error handler yet. — platform-monolith plateau
domain: skill
type: template
...
/apps/platform-shell
  /src
    ...
    /app
      ...
      app.routes.ts
      /remote-registry
        [remote-registry.service.ts](./classes/plateau-platform-monolith--class-remote-registry-service.skill.md)
      /shell
        shell.component.ts            <- mounts a resolved remote via loadRemoteModule
    /preloading
      selective-preloading.strategy.ts
    sw-build.ts                       <- see [plateau-platform-monolith--class-service-worker.skill.md](./classes/plateau-platform-monolith--class-service-worker.skill.md)
    sw-src.ts                         <- see [plateau-platform-monolith--class-service-worker.skill.md](./classes/plateau-platform-monolith--class-service-worker.skill.md)
    main.ts
```
...
## MUST NOT
- [[skills/angular/architecture/plateau/plateau-platform-monolith/structure/plateau-platform-monolith--repo-platform-monolith.skill#MUST NOT|repo-platform-monolith]]
