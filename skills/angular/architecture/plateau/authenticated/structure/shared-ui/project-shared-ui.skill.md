...
> No solution produced a dedicated `shared-ui.project.create.md` file — this project is established implicitly by [[../repo-authenticated.skill.md|repo-authenticated]]'s `Repository.create` directory table. Unchanged since [[skills/angular/architecture/plateau/foundation/plateau-foundation.skill.md|foundation]].
