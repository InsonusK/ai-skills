...
- Directly follows from the shared-document architecture Native Federation was chosen for in the "Встраиваемость платформы" solution — this is a natural consequence, not an extra mechanism to build
