...
- The future `solution-logging-global` adds a second sink (e.g. `BackendLogSink`) by registering it alongside `ConsoleLogSink` — no call site anywhere in the codebase changes
