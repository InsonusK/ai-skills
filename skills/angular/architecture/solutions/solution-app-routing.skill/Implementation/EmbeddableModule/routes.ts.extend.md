...
This applies inside any embeddable application repository (see the platform-embeddability solution's "встраиваемое приложение" plateau) that itself contains more than one feature. It is the same mounting pattern as the shell's, one level down.
