...
- **Writing a large number of fine-grained e2e tests for logic already covered by unit/component tests**
  ...
  - Instead: keep e2e tests focused on a small set of critical, cross-cutting user journeys; push detailed logic coverage down to unit/component/integration tests
