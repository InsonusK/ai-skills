...
- Same category of objection already raised against Chromatic in [[skills/angular/architecture/solutions/testing/solution-ui-testing.skill/adr/visual-regression-approach]] — introduces an external dependency for a check that can be run entirely in-house with tooling already adopted
