...
- [ ] WHEN the production build completes THEN
  ...
  - [ ] it contains the five routing rules defined in [[skills/angular/architecture/solutions/solution-offline-first.skill/Implementation/ServiceWorker/service-worker.create]]
