...
depends_on: []
adr:
  - "[[skills/angular/architecture/solutions/solution-design-system-structure.skill/adr/design-system-workspace-tooling]]"
  - "[[skills/angular/architecture/solutions/solution-design-system-structure.skill/adr/library-build-tooling]]"
  - "[[skills/angular/architecture/solutions/solution-design-system-structure.skill/adr/release-versioning-strategy]]"
  - "[[skills/angular/architecture/solutions/solution-design-system-structure.skill/adr/component-preview-tooling]]"
---
...
- [[skills/angular/architecture/solutions/solution-design-system-structure.skill/adr/design-system-workspace-tooling|Angular CLI multi-project workspace instead of Nx]]
...
- [[skills/angular/architecture/solutions/solution-design-system-structure.skill/adr/library-build-tooling|ng-packagr instead of a custom Vite/Rollup build]]
  - Selected variant: ng-packagr — the official tool for Angular Package Format compliance and Ivy partial compilation
- [[skills/angular/architecture/solutions/solution-design-system-structure.skill/adr/release-versioning-strategy|Changesets instead of manual semver/CHANGELOG]]
...
- [[skills/angular/architecture/solutions/solution-design-system-structure.skill/adr/component-preview-tooling|Self-built demo Angular app instead of Storybook]]
...
NPM:
- ng-packagr
  - Library build, per [[skills/angular/architecture/solutions/solution-design-system-structure.skill/adr/library-build-tooling]]
- @changesets/cli
  - Version bump classification and CHANGELOG generation, per [[skills/angular/architecture/solutions/solution-design-system-structure.skill/adr/release-versioning-strategy]]

# Template Skill Mutations

REPOSITORY:
- [[skills/angular/architecture/solutions/solution-design-system-structure.skill/Implementation/Repository.create|Repository]] - create - Angular CLI multi-project workspace with the publishable `design-system` library, the `demo` preview application, ng-packagr build config, and Changesets configuration
...
2. CI fails per [[skills/angular/architecture/solutions/solution-design-system-structure.skill/Implementation/Repository.create#Unittest TestCases]], blocking merge until a changeset is added.
...
## MUST
- [[skills/angular/architecture/solutions/solution-design-system-structure.skill/Implementation/Repository.create#MUST|Repository]]

## SHOULD
- [[skills/angular/architecture/solutions/solution-design-system-structure.skill/Implementation/Repository.create#SHOULD|Repository]]

# Anti-patterns

- [[skills/angular/architecture/solutions/solution-design-system-structure.skill/Implementation/Repository.create|See Repository.create.md]] — publishing without a changeset; reintroducing Storybook for an individual component after this repository already decided against it.
