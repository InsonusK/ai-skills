...
problem: The platform hosts embeddable apps from separate teams (per the "Встраиваемость платформы" solution); a multi-brand/per-tenant theming capability could be built now, or deferred until an actual need for it appears
