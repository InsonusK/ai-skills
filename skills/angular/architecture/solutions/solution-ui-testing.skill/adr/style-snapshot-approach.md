...
### Description
Keep relying solely on [[skills/angular/architecture/solutions/solution-ui-testing.skill/adr/visual-regression-approach.md|the existing pixel-diff visual spec]]; address false positives/negatives purely by adjusting Playwright's diff threshold.
