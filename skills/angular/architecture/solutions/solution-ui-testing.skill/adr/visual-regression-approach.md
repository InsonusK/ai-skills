...
- No new tool or vendor: Playwright is already the adopted e2e framework (see [[skills/angular/architecture/solutions/solution-app-testing.skill/adr/e2e-framework-choice]]) — this is the same tool, a different assertion
