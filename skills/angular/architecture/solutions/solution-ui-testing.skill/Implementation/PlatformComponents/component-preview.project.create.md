...
- Every component covered by a visual regression or accessibility spec (per [[skills/angular/architecture/solutions/solution-ui-testing.skill/adr/visual-regression-approach]]) MUST have its `spec/preview/{component-name}.preview.ts` registered as a route in this app.
