...
| --- | --- | --- | --- | --- | --- | --- |
| VP1 | **GrpcApi** — does the module expose a second inbound entry point over gRPC, alongside the common `HttpApi`? | Yes / No | — | Yes → [[skills/go/architecture/solutions/solution-grpc-api.skill/solution-grpc-api.skill\|solution-grpc-api]] | — | No |
| VP2 | **ExternalIntegration** — does the module call out to another service through a domain-declared outbound port? | Yes / No | — | Yes → [[skills/go/architecture/solutions/solution-external-integration.skill/solution-external-integration.skill\|solution-external-integration]] | — | No |
