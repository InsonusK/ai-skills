---
name: plateau-cached-service--package-api-grpc
description: internal/api/grpc package of the plateau-cached-service plateau
...
```
internal/api/grpc/
  server.go        ← Server, see plateau-cached-service--file-api-grpc-server.skill.md
```
