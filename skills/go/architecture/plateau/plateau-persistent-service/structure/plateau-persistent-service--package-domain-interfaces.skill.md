---
name: plateau-persistent-service--package-domain-interfaces
description: internal/domain/interfaces package of the plateau-persistent-service plateau
...
internal/domain/interfaces/
  reputation.go        ← ReputationChecker port, see plateau-persistent-service--file-domain-interfaces-reputation.skill.md
  reputation_cache.go  ← ReputationCache port, see plateau-persistent-service--file-domain-interfaces-reputation-cache.skill.md
  link_history.go       ← LinkHistory port, see plateau-persistent-service--file-domain-interfaces-link-history.skill.md
```
