---
name: plateau-persistent-service--package-api-grpc
description: internal/api/grpc package of the plateau-persistent-service plateau
...
```
internal/api/grpc/
  server.go        ← Server, see plateau-persistent-service--file-api-grpc-server.skill.md
```
