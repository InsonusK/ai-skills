---
name: plateau-persistent-service--package-infrastructure-reputationclient
description: internal/infrastructure/reputationclient package of the plateau-persistent-service plateau
...
internal/infrastructure/reputationclient/
  client.go      ← Client, see plateau-persistent-service--file-infrastructure-reputationclient-client.skill.md
```

## Directory and file skills
| Directory\|file | Description | Pattern skill |
| --------------- | ----------- | -------------- |
| client.go | `Client` implementing `ReputationChecker` via `gen/reputation` | [[skills/go/architecture/plateau/plateau-persistent-service/structure/plateau-persistent-service--file-infrastructure-reputationclient-client.skill.md]] |
