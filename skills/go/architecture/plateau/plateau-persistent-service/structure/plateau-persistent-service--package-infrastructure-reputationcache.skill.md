---
name: plateau-persistent-service--package-infrastructure-reputationcache
description: internal/infrastructure/reputationcache package of the plateau-persistent-service plateau
...
internal/infrastructure/reputationcache/
  store.go      ← Store, see plateau-persistent-service--file-infrastructure-reputationcache-store.skill.md
```

## Directory and file skills
| Directory\|file | Description | Pattern skill |
| --------------- | ----------- | -------------- |
| store.go | `Store` implementing `ReputationCache` via `github.com/redis/go-redis/v9` | [[skills/go/architecture/plateau/plateau-persistent-service/structure/plateau-persistent-service--file-infrastructure-reputationcache-store.skill.md]] |
