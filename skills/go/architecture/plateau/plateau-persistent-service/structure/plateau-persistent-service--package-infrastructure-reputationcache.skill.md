...
| --------------- | ----------- | -------------- |
| store.go | `Store` implementing `ReputationCache` via `github.com/redis/go-redis/v9` | [[plateau-persistent-service--file-infrastructure-reputationcache-store.skill.md]] |
