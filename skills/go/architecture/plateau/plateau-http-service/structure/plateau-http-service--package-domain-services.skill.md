---
name: plateau-http-service--package-domain-services
description: internal/domain/services package of the plateau-http-service plateau
...
internal/domain/services/
  linkcheck.go          ← LinkCheckService, see plateau-http-service--file-domain-services-linkcheck.skill.md
  features/
    check.feature
  test/
    world_test.go
...
| --------------- | ----------- | -------------- |
| linkcheck.go | `LinkCheckService`: validates and normalizes a URL | [[skills/go/architecture/plateau/plateau-http-service/structure/plateau-http-service--file-domain-services-linkcheck.skill.md]] |
