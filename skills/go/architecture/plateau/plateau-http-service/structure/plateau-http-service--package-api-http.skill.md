---
name: plateau-http-service--package-api-http
description: internal/api/http package of the plateau-http-service plateau
...
```
internal/api/http/
  server.go        ← Server, see plateau-http-service--file-api-http-server.skill.md
```

## Directory and file skills
| Directory\|file | Description | Pattern skill |
| --------------- | ----------- | -------------- |
| server.go | `Server`: `GET /health`, `POST /v1/links/check` | [[skills/go/architecture/plateau/plateau-http-service/structure/plateau-http-service--file-api-http-server.skill.md]] |
