---
name: plateau-integrated-service--package-api-grpc
description: internal/api/grpc package of the plateau-integrated-service plateau
...
```
internal/api/grpc/
  server.go        ← Server, see plateau-integrated-service--file-api-grpc-server.skill.md
```

## Directory and file skills
| Directory\|file | Description | Pattern skill |
| --------------- | ----------- | -------------- |
| server.go | `Server`: implements the generated `LinkCheckServiceServer`, one RPC (`Check`) | [[skills/go/architecture/plateau/plateau-integrated-service/structure/plateau-integrated-service--file-api-grpc-server.skill.md]] |
