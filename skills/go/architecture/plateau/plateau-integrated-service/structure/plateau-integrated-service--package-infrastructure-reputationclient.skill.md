...
| --------------- | ----------- | -------------- |
| client.go | `Client` implementing `ReputationChecker` via `gen/reputation` | [[skills/go/architecture/plateau/plateau-integrated-service/structure/plateau-integrated-service--file-infrastructure-reputationclient-client.skill.md]] |
