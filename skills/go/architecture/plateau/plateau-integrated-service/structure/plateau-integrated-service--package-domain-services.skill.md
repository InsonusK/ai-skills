---
name: plateau-integrated-service--package-domain-services
description: internal/domain/services package of the plateau-integrated-service plateau
...
internal/domain/services/
  linkcheck.go          ← LinkCheckService, see plateau-integrated-service--file-domain-services-linkcheck.skill.md
  features/
    check.feature
  test/
    world_test.go
...
| --------------- | ----------- | -------------- |
| linkcheck.go | `LinkCheckService`: validates and normalizes a URL | [[skills/go/architecture/plateau/plateau-integrated-service/structure/plateau-integrated-service--file-domain-services-linkcheck.skill.md]] |
