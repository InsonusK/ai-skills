      ...
      with:
        filters: |
          ...
          docs:
            ...
            - '*.md'
```
- Violation: filtering on `tests/**` (plural) or omitting `features/**`, which drifts from `test/`/`features/` — the paths [solution-test](skills/python/architecture/solutions/solution-test.skill/solution-test.skill.md) and [python-solution-conformance-testing](skills/python/architecture/solutions/python-solution-conformance-testing.skill/python-solution-conformance-testing.skill.md) actually create.
